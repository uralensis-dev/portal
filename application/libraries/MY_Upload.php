...
class MY_Upload extends CI_Upload
{
    ...
    public function do_upload($field = 'userfile') {
        ...
        else
        {
            ...
            foreach ($files['name'] as $key => $value)
            {
                ...
                {
                    // if the upload was successful add an element to the uploadedFiles array that contains the data regarding the uploaded file
                    $this->uploadedFiles[] = $this->data();
                }
                else
                {
                    // if the upload was unsuccessful, set a temporary string that will contain the name of the file in question. The string will later be used by the modified display_errors() method
    ...
    {
        //first we look if the files were uploaded. if they were we just return the array with the data regarding the uploaded files

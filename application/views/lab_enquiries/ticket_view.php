                                                        ...
                                                        <div class="chat-content">
                                                                <span class="task-chat-user">
                                                                    <?php if (($this->ion_auth->user()->row()->id == $comment['ticket_comment_addedBy'])) {
                                                                        echo "You";
                                                                        echo "<a href='" . site_url('labEnquiries/deleteComment/' . $comment['ticket_comment_id'] . "/" . $comment['comment_ticket_id']) . "' class='pull-right text-danger'><i class='fa fa-times'></i> </a>";
                                                                    } else {
                    ...
                    <div class="message-bar">
                        <div class="message-inner">
                            <div class="message-area">
                                ...
                                echo form_open("labEnquiries/addComment/", $attributes);
                                ?>

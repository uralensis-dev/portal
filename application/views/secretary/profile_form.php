...
<div class="row">
    <div style="width:60%;margin:0 auto;">
        ...
        <form enctype="multipart/form-data" id="dashboard_profile" class="form" action="<?php echo base_url('index.php/secretary/update_profile'); ?>" method="post">
            <div class="row">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="tel" name="phone" id="phone" value="<?php echo (!empty($phone)) ? html_purify($phone) : ''; ?>" >
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="hidden" name="profile_picture_hidden" value="<?php echo (!empty($profile_picture_path)) ? html_purify($profile_picture_path) : ''; ?>" >
                        <span>
                          <?php echo (!empty($profile_picture_path)) ? html_purify($profile_picture_path) : ''; ?>  
                        </span>
                    </div>
                </div>
            </div>

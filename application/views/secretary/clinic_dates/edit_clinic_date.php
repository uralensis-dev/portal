...
<div class="row">
    <div class="col-md-12">
        <?php
        $hospital_id = '';
        if (isset($_GET) && !empty($_GET['hopital_id'])) {
            $hospital_id = $_GET['hopital_id'];
        }
        ?>
        <a href="<?php echo base_url('index.php/secretary/show_clinic_dates/?hospital_id=' . intval($hospital_id)); ?>" class="btn btn-primary">Go Back</a>
        <?php
...
?>
<div class="row">
    <form id="edit_clinic_date_form" action="<?php echo base_url('index.php/secretary/process_edit_clinic_date'); ?>" enctype="multipart/form-data" method="post">
        <div class="col-md-6">
            <div class="form-group">
                <label for="total_patients">Total Patients</label>
                <input class="form-control" id="total_patients" type="text" name="total_patients" placeholder="Total No of Patients" value="<?php echo!empty($total_patients) ? intval($total_patients) : ''; ?>">
            </div>
            <div class="form-group">
                <label for="total_samples">Total Samples</label>
                <input class="form-control" id="total_samples" type="text" name="total_samples" placeholder="Total No of Sampels" value="<?php echo!empty($total_samples) ? intval($total_samples) : ''; ?>">
            </div>
            <div class="form-group">
                <label for="imf_samples">IMF Samples</label>
                <input class="form-control" id="imf_samples" type="text" name="imf_samples" placeholder="Total No of IMF Samples" value="<?php echo!empty($imf_samples) ? intval($imf_samples) : ''; ?>">
            </div>
            <div class="form-group">
                ...
                <select name="clinic_batches" id="clinic_batches" class="form-control">
                    ...
                    if (!empty($batches_list)) {
                        foreach ($batches_list as $batch) {
                            ...
                            echo '<option ' . $selected . ' value="' . intval($batch->ura_batches_id) . '">' . html_purify($batch->ura_batch_ref) . '</option>';
                        }
                    }
                    ?>
                </select>
                            ...
                            if (!empty($checklist_data)) {
                                ...
                                foreach ($checklist_data as $checklist) {
                                    ...
                                    <li class="list-group-item"><?php echo $checklist->ura_clinic_checklist_form; ?>
                                        <a data-filetype="checklist_files" data-fileid="<?php echo intval($checklist->ucd_checklist_upload_id); ?>" href="javascript:;" class="delete_clinic_files">
                                            <i class="glyphicon glyphicon-remove pull-right" style="color: red;"></i>
                                        </a>
                                        <a data-exttype="<?php echo html_purify($modify_ext); ?>" class="hover_image" data-imageurl="<?php echo base_url() . 'clinic_uploads/' . $checklist->ura_clinic_checklist_form; ?>" href="<?php echo base_url() . 'clinic_uploads/' . $checklist->ura_clinic_checklist_form; ?>" target="_blank">
                                        ...
                                        <?php if ($modify_ext === 'png' || $modify_ext === 'jpg') { ?>
                                            <div style="display:none;" class="hover_image_frame clinic_docs_frame hover_<?php echo html_purify($modify_ext); ?>" >
                            ...
                            if (!empty($request_data)) {
                                ...
                                foreach ($request_data as $request) {
                                    ...
                                    <li class="list-group-item"><?php echo $request->ura_clinic_request_form; ?>
                                        <a data-filetype="request_files" data-fileid="<?php echo intval($request->ucd_requestform_upload_id); ?>" href="javascript:;" class="delete_clinic_files">
                                            <i class="glyphicon glyphicon-remove pull-right" style="color: red;"></i>
                                        </a>
                                        <a data-exttype="<?php echo html_purify($modify_ext); ?>" class="hover_image" data-imageurl="<?php echo base_url() . 'clinic_uploads/' . $request->ura_clinic_request_form; ?>" href="<?php echo base_url() . 'clinic_uploads/' . $request->ura_clinic_request_form; ?>" target="_blank">
                                            <i class="glyphicon glyphicon-eye-open pull-right" style="color:#5cb85c; margin-right:10px;"></i>
                                        </a>
                                        <?php if ($modify_ext === 'png' || $modify_ext === 'jpg') { ?>
                                            <div style="display:none;" class="hover_image_frame clinic_docs_frame hover_<?php echo html_purify($modify_ext); ?>" >
                            ...
                            if (!empty($otherdoc_data)) {
                                ...
                                foreach ($otherdoc_data as $otherdoc) {
                                    ...
                                    <li class="list-group-item"><?php echo $otherdoc->ura_clinic_otherdoc_form; ?>
                                        <a data-filetype="other_files" data-fileid="<?php echo intval($otherdoc->ucd_otherdocs_upload_id); ?>" href="javascript:;" class="delete_clinic_files">
                                            <i class="glyphicon glyphicon-remove pull-right" style="color: red;"></i>
                                        </a>
                                        <a data-exttype="<?php echo html_purify($modify_ext); ?>" class="hover_image" data-imageurl="<?php echo base_url() . 'clinic_uploads/' . $otherdoc->ura_clinic_otherdoc_form; ?>" href="<?php echo base_url() . 'clinic_uploads/' . $otherdoc->ura_clinic_otherdoc_form; ?>" target="_blank">
                                            <i class="glyphicon glyphicon-eye-open pull-right" style="color:#5cb85c; margin-right:10px;"></i>
                                        </a>
                                        <?php if ($modify_ext === 'png' || $modify_ext === 'jpg') { ?>
                                            <div style="display:none;" class="hover_image_frame clinic_docs_frame hover_<?php echo html_purify($modify_ext); ?>" >
        ...
        <div class="col-md-12">
            ...
            <div class="form-group">
                ...
                ?>
                <input type="hidden" name="rec_id" value="<?php echo intval($rec_id); ?>">
                <input type="hidden" name="hospital_id" value="<?php echo intval($hopital_id); ?>">
        ...
        <tbody>
            <?php $request_form_count = 1; foreach ($request_form as $row) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url() . '/secretary/record_detail/' . intval($row->uralensis_request_id); ?>"><img src="<?php echo base_url('assets/img/detail.png'); ?>"></a></td>
                    <td>
                        <?php
                    ...
                    <td>
                        <?php if ($row->specimen_publish_status == 1) { ?>
                            <button class="record_id_unpublish btn btn-link" data-recordserial="<?php echo $row->serial_number; ?>" data-unpublishrecordid="<?php echo site_url() . '/admin/unpublish_record/' . intval($row->uralensis_request_id); ?>">
                                Un-Publish
                            </button>
                            <?php
                        } else {
                    ...
                    <td>
                        ...
                        $request_form_data = $this->Secretary_model->get_request_form_data($request_form_id, $clinic_record_id);
                        if (!empty($request_form_data)) {
                            ...
                            ?>
                            <a href="javascript:;" id="add_request_form_<?php echo $request_form_count; ?>" data-countvalue="<?php echo $request_form_count; ?>" data-recordid="<?php echo intval($row->uralensis_request_id); ?>" data-clinicid="<?php echo intval($clinic_record_id); ?>">Assign Request Form</a>
                            <?php
                        }
                        ?>
                    </td>

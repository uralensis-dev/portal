...
<!--                                            </span>-->
            ...
            <li class="nav-item dropdown">
                ...
                <!-- <a href="<?php //echo base_url() ?>pm/index" class="dropdown-toggle nav-link hide_if_no_email" data-toggle="dropdown">
                    <i class="fa fa-comment-o"></i> <span class="badge badge-pill count_badge"><?php //echo count(getUnreadMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?></span>
                </a> -->
                 <?php 

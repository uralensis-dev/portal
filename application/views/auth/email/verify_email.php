            ...
            <table style="max-width: 600px;" width="100%" cellspacing="0" cellpadding="0" border="0">
                            ...
                            <tr>
                                <td style="padding: 20px 30px 60px 30px;" bgcolor="#ffffff" align="center">
                                    <table cellspacing="0" cellpadding="0" border="0">
                                        <tbody>
                                        <tr>
                                            <td style="border-radius: 3px;" bgcolor="#0183E0" align="center"><a href="<?php echo base_url()."auth/verifyEmail/".base64_encode($email); ?>"
                                                                                                                target="_blank"
                ...
                <tr>
                    <td style="padding: 20px 30px 20px 30px; color: #666666; font-family: 'Lato', Helvetica, Arial, sans-serif; font-size: 18px; font-weight: 400; line-height: 25px;"
                        bgcolor="#ffffff" align="left">
                        <p style="margin: 0;"><a href="<?php echo base_url()."auth/verifyEmail/".base64_encode($email); ?>" target="_blank" style="color: #0183E0;"><?php echo base_url()."auth/verifyEmail/".base64_encode($email); ?></a>
                        </p>
                    </td>
                </tr>
                <tr>

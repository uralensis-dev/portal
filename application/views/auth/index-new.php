...
<div id="list_view" class="hidden">
   <div class="row">
       <div class="col-sm-12 button-delete form-group" style="text-align:end; margin-bottom: 0px;">
           <button class="btn-danger text-end selected_delete" style="background: #e58396; border: 1px solid #e58396; "><i class="fa fa-trash"></i> Delete </button>
       </div>
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped custom-table datatable">
                    <thead>
                        <tr>
                            <th><input type="checkbox" name="check_all" class="checkAll custom-checkbox"></th>
                            <th>Name</th>
                            <th>Institute</th>
                            <th>Contact</th>
                            <!-- <th>Mobile</th> -->
                    ...
                    foreach ($usersList as $key => $value) {
                        ...
                        <tr>
                            <td>
                                <input type="checkbox" class="checkSingle custom-checkbox" value="<?= $value->user_id; ?>">
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                <input type="checkbox" class="update-directory custom-checkbox" value="<?= $value->in_directory; ?>" data-id="<?= $value->user_id; ?>" <?= (!empty($value->in_directory) ? 'checked' :''); ?> />
                            </td>
                            <td class="text-right">

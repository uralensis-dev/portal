							...
							<div class="pro-teams">
								<div class="pro-team-lead">
									...
									<div class="avatar-group">
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-11.jpg'); ?>">
										</div>
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-01.jpg'); ?>">
										</div>
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-16.jpg'); ?>">
										</div>
										<div class="avatar">
								...
								<div class="pro-team-members">
									...
									<div class="avatar-group">
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-02.jpg'); ?>">
										</div>
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-09.jpg'); ?>">
										</div>
										<div class="avatar">
											<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-12.jpg'); ?>">
										</div>
										<div class="avatar">
												...
												<div class="task-board-body">
													...
													<div class="kanban-footer">
														...
														<span class="task-users">
															<img src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-12.jpg'); ?>" class="task-avatar" width="24" height="24">
														</span>
													</div>
												</div>
											</div>
							...
							<div>
								<ul class="chat-user-list">
									<li>
										<a href="#">
											<div class="media">
												<span class="avatar"><img alt="" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-09.jpg'); ?>"></span>
									...
									<li>
										<a href="#">
											<div class="media">
												<span class="avatar"><img alt="" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-10.jpg'); ?>"></span>
												<div class="media-body align-self-center text-nowrap">
									...
									<li>
										<a href="#">
											<div class="media">
												<span class="avatar">
													<img alt="" src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-16.jpg'); ?>">
												</span>
												<div class="media-body align-self-center text-nowrap">
								...
								<div class="form-group">
									...
									<div class="task-follower-list">
										<span data-toggle="tooltip" title="John Doe">
											<img src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-02.jpg'); ?>" class="avatar" alt="John Doe" width="20" height="20">
											<i class="fa fa-times"></i>
										</span>
										<span data-toggle="tooltip" title="Richard Miles">
											<img src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-09.jpg'); ?>" class="avatar" alt="Richard Miles" width="20" height="20">
											<i class="fa fa-times"></i>
										</span>
										<span data-toggle="tooltip" title="John Smith">
											<img src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-10.jpg'); ?>" class="avatar" alt="John Smith" width="20" height="20">
											<i class="fa fa-times"></i>
										</span>
										<span data-toggle="tooltip" title="Mike Litorus">
											<img src="<?php echo base_url('/assets/newtheme/img/profiles/avatar-05.jpg'); ?>" class="avatar" alt="Mike Litorus" width="20" height="20">
											<i class="fa fa-times"></i>
										</span>
									</div>
								</div>

	...
	<div class="doctorSCard">
            <div class="row">
                <div class="col-sm-6 col-md-3">
                    <h4 class="title_specimen">Leave Settings.</h4>
                </div>
                <div class="col-sm-6 col-md-3">
                        ...
                        <i class="fa fa-file-o"></i>
						  ...
						  <select class="form-control">
						   ...
						   <span class="tooltipIcon" data-toggle="tooltip" title="Pathologist/Specialty/Clinic/Physician/Specimen No.">
                            <img src="http://localhost/pathhub/assets/institute/img/infoIcon.png">
                        </span>
                        <button type="button" class="btn btn-primary add_temp" data-toggle="dropdown" aria-expanded="false">
                            <i class="fa fa-ellipsis-v"></i></button>
                        <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-end" style="position: absolute; transform: translate3d(107px, 40px, 0px); top: 0px; left: 0px; will-change: transform;">
							...
							<table class="table table-hover table-nowrap leave-table mb-0">
								...
								<tbody>
									<tr>
										...
										<td>5</td>
										<td>
											<a href="javascript:;" class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></a>
											<a href="javascript:;">John Doe</a>
										</td>
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a aria-expanded="false" data-toggle="dropdown" class="action-icon dropdown-toggle" href="javascript:;"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
													<a href="javascript:;" class="dropdown-item" data-toggle="modal" data-target="#edit_custom_policy"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a href="javascript:;" class="dropdown-item" data-toggle="modal" data-target="#delete_custom_policy"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>
									...
									<tr>
										...
										<td class="text-right">
											<div class="dropdown dropdown-action">
												<a aria-expanded="false" data-toggle="dropdown" class="action-icon dropdown-toggle" href="javascript:;"><i class="fa fa-ellipsis-v"></i></a>
												<div class="dropdown-menu dropdown-menu-right">
													<a href="javascript:;" class="dropdown-item"><i class="fa fa-pencil m-r-5"></i> Edit</a>
													<a href="javascript:;" class="dropdown-item"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
												</div>
											</div>
										</td>
									</tr>

		...
		<div class="col-md-12">
			<div class="welcome-box">
				...
				<div class="welcome-det">
					<h3>Welcome, Iskandar</h3>
					<p>Monday, 20 June 2020</p>
				</div>
			</div>
		</div>
	</div>
						...
						<a href="#" class="dash-card text-danger">
							<div class="dash-card-container">
								...
								<div class="dash-card-avatars">
									<div class="e-avatar"><img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" alt=""></div>
								</div>
							</div>
						</a>
					</div>
					...
					<div class="dash-info-list">
						<div class="dash-card">
							<div class="dash-card-container">
								...
								<div class="dash-card-avatars">
									<a href="#" class="e-avatar"><img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" alt=""></a>
									<a href="#" class="e-avatar"><img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" alt=""></a>
								</div>
							</div>
						</div>

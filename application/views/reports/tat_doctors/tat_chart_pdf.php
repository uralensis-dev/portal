...
<table width="100%">
    <tr>
        ...
        <td  align="left" style=" font-size:15px; font-family: 'Trebuchet MS', Arial, Helvetica, sans-serif;" ><b style="height: 2em;">TAT Last 12 Months - $user</b></td>
    </tr>
</table>
EOD;
...
$pdf->SetTitle('TAT Last 12 Months') . ' - ' . $user_name;
...
<tr >
<th style="color: white; background-color: #A0A0A0; border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left;">Month Publish</th>
<th style="color: white; background-color: #A0A0A0; border: 1px solid #ddd; padding: 8px; padding-top: 12px; padding-bottom: 12px; text-align: left;">Case No.</th>
...
foreach ($twelve_month_tat as $key=>$value){
    ...
    $html.= '
        <tr>
        <td style="border: 1px solid #ddd; padding: 8px;">'.$value->publish_month.'</td>
...
$file_name = 'TAT_Last_12_Months_' . $user_name. '_' . date('dMY') . '.pdf';
ob_end_clean();

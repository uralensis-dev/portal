		...
		<div class="row align-items-center">
			<div class="col">
				...
				<ul class="breadcrumb">
					...
					<li class="breadcrumb-item"><a href="<?php echo base_url() ?>index.php/performance/review">Performance</a></li>
					<li class="breadcrumb-item active">Appraisal</li>
				</ul>
			</div>
			<div class="col-auto float-right ml-auto">
				<a href="javascript:;" class="btn add-btn" data-toggle="modal" data-target="#add_appraisal"><i class="fa fa-plus"></i> Add New</a>
			</div>
		</div>
	</div>
	<!-- /Page Header -->
					...
					<tbody>
							...
							<td>
								<div class="dropdown action-label">
									...
									<div class="dropdown-menu">
										<a class="dropdown-item" href="javascript:;"><i class="fa fa-dot-circle-o text-success"></i> Active</a>
										<a class="dropdown-item" href="javascript:;"><i class="fa fa-dot-circle-o text-danger"></i> Inactive</a>
									</div>
								</div>
							</td>
							<td class="text-right">
								<div class="dropdown dropdown-action">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#edit_appraisal"><i class="fa fa-pencil m-r-5"></i> Edit</a>
										<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#delete_appraisal"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
									</div>
								</div>
							</td>
						</tr>
						<tr>
							...
							<td>
								<h2 class="table-avatar">
									<a href="javascript:;" class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></a>
									<a href="javascript:;">Mike Litorus </a>
								</h2>
							</td>
							<td>IOS Developer </td>
							<td>IOS</td>
						...
						<tr>
							...
							<td>
								<h2 class="table-avatar">
									<a href="javascript:;" class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></a>
									<a href="javascript:;">Bernardo Galaviz </a>
								</h2>
							</td>
							<td>Web Developer </td>
							<td>Designing</td>
						...
						<tr>
							...
							<td>
								<h2 class="table-avatar">
									<a href="javascript:;" class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></a>
									<a href="javascript:;">Jeffrey Warden </a>
								</h2>
							</td>
							<td>Web Developer </td>
							<td>Designing</td>
						...
						<tr>
							...
							<td>
								<h2 class="table-avatar">
									<a href="javascript:;" class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></a>
									<a href="javascript:;">Wilmer Deluna </a>
								</h2>
							</td>
							<td>Team Leader </td>
							<td>IOS</td>

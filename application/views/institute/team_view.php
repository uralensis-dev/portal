...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            ...
            <ul class="breadcrumb">
                <li class="breadcrumb-item"><a href="<?php echo base_url('/institute'); ?>">Dashboard</a></li>
        ...
        <div class="col-auto float-right ml-auto">
            ...
            <div class="view-icons">
                <a style="margin-right: 10px;" href="<?php echo base_url()."institute/settings/?new_user".base64_encode($group_id); ?>" class="btn add-btn"><i class="fa fa-plus"></i> User</a>

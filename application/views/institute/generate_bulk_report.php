...
if (!empty($id)) {
    ...
    $query1 = $this->Institute_model->doctor_record_detail($id);
    $query2 = $this->Institute_model->doctor_record_detail_specimen($id);
    $query4 = $this->Institute_model->get_additional_work($id);
    $query5 = $this->Institute_model->get_hospital_info($id);
    ...
    require_once(APPPATH . 'views/institute/class-bulkreport.php');

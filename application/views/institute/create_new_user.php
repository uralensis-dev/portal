        ...
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            <div class="tg-dashboardbox">
                ...
                <div class="tg-editformholder">
                    ...
                    <?php echo form_open_multipart(($cgroup_id && $cgroup_id != '') ? "institute/create_user/".base64_encode($cgroup_id) : "institute/create_user", array('class' => 'tg-formtheme tg-editform create_user_form','id' => 'create_user_form')); ?>

...
<div class="page-header">
    <div class="row align-items-center">
        ...
        <div class="col-auto float-right ml-auto">
            <a href="<?php echo base_url("/auth/create_hospital"); ?>" class="btn add-btn" ><i class="fa fa-plus"></i>Add Clinic</a>
...
<div id="grid_view" class="fade hidden show">
    ...
    <?php
	                  $cnt =0;                            
                      foreach($hos_info as $resKey => $resValue) 
                      {
                          $cnt ++;
                      ?>   
        ...
        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
                ...
                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><?php echo $resValue["description"];?></h4>
               <br /> <div class="small text-muted"><?php echo $resValue["hosp_city"];?></div>
            </div>
        </div>
                    ...
                    <tbody> 
                      ...
                      ?>                    
                        <tr>
                            ...
                            <td>0</td>
                            <td>0</td>                        
                            <td ><a class="dropdown-item" href="<?php echo base_url();?>auth/delete_group/<?php echo $resValue["id"];?>"><i class="fa fa-pencil m-r-5"></i></a> <a class="dropdown-item" onclick="return confirm('Are you sure you want to delete this group?');" href="<?php echo base_url();?>auth/delete_group/<?php echo $resValue["id"];?>"><i class="fa fa-trash-o m-r-5"></i></a>                                    

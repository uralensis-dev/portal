<html lang="en">
    <head>
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" type="image/x-icon" href="<?php echo base_url() ?>/assets/institute/img/favicon.png">
        ...
        <!--[if lt IE 9]>
            <script src="<?php echo base_url() ?>/assets/institute/js/html5shiv.min.js"></script>
            <script src="<?php echo base_url() ?>/assets/institute/js/respond.min.js"></script>
        <![endif]-->
    </head>
                    ...
                    <li class="nav-item">
                        <a class="btn-icon" href="#">
                            <span>
                                ...
                                <img class="mt-1" src="<?php echo base_url() ?>/assets/institute/img/layersIconMenu.png">
                            </span>
                            <span>Reported</span>
                        </a>
                    </li>

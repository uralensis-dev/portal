...
<table border="1" cellpadding="7">
    ...
    <th width="10%;">EMIS Number</th>
    <th width="10%;">Date of Birth</th>
    <th width="10%;">Sex</th>
    <th width="10%;">Clinic Ref</th>
</tr>
';
$tat2w_csv = $this->Institute_model->generate_tat2w_model($group_id, $tat_opt);

foreach ($tat2w_csv as $row) {
    $html .= '<tr>';
...
$file_name = 'TAT_2_Week_Report_' . $group_name . '_' . date('dMY') . '.pdf';
ob_end_clean();

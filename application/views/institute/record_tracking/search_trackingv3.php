            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="tg-trackhead">
                    ...
                    <div class="tg-rightarea">
                        <a class="tg-btnmore load_more_templates sp-loadMore" href="javascript:;"><span>More</span><i class="fa fa-angle-down"></i></a>
                        <a class="tg-btnmore load_more_templates sp-showLess" href="javascript:;"><span>Less</span><i class="fa fa-angle-down"></i></a>
                    </div>
                    ...
                    <div class="tg-tabcontent tab-content tab_status_content">
                        <div role="tabpanel" class="tab-pane fade active in" id="admin">
                            <ul class="tg-findbtnsarea track_status_list">
                                <li>
                                    <a href="javascript:;" class="check_status_btn" data-statuscode="Booked In From Clinic">
                                        <span>Booked In</span>
                                        <h3>From Clinic</h3>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="check_status_btn" data-statuscode="Booked Out To Lab Primary Release">
                                        <span>Booked Out To Lab</span>
                                        <h3>Primary Release</h3>
                                    </a>
                                </li>
                                <li>
                                    <a href="javascript:;" class="check_status_btn" data-statuscode="Booked Out To Lab FW Completed">
                                        <span>Booked Out To Lab</span>
                                        <h3>FW Completed</h3>
                                    </a>
                                </li>

        ...
        <form method="get" action="<?php echo base_url('index.php/institute/find_mdt_cases'); ?>" class="form">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    if (!empty($coming_mdt)) {
                        ...
                        ?>
                        <select class="form-control" name="mdt_dates" id="mdt_dates" data-hospital-id="<?php echo intval($coming_mdt[0]->ura_mdt_hospital_id); ?>">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    if (!empty($prev_mdt)) {
                        ?>
                        <select class="form-control" name="prev_mdt_dates" id="prev_mdt_dates" data-hospital-id="<?php echo intval($prev_mdt[0]->ura_mdt_hospital_id); ?>">

...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title">Published Records</h3>
            <!-- <ul class="breadcrumb">
            ...
            <table id="admin_display_records"  class="table table-striped custom-table mb-0">
                <thead>
                    <tr>
                        ...
                        <th><img src="<?php echo base_url();?>assets/icons/Actions-Black.png" class="img-responsive pull-right" title="Actions" style="width: 30px"></th>
...
function load_filtered_data(docIDs) 
	{
		...
		var docs_ids = docIDs;
		//alert(docs_ids);
        var ajax_url = "<?php echo base_url('index.php/admin/display_all_ajax_published/'); ?>";

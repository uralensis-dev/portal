...
<div class="row">
    <div class="col-md-12">
        ...
        <?php } ?>
        <form class="form" method="post" action="<?php echo site_url('admin/add_specimen'); ?>">
            <div class="col-md-6">
        ...
        if ($this->session->flashdata('specimen_add_msg')) {
            ?>
            <div class="pull-right"><a href="<?php echo base_url('index.php/admin/finish_specimen'); ?>"><button id="finish_specimen" class="btn btn-warning">Finish Specimen</button></a></div>

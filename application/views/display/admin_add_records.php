...
<div class="row">
    <div class="col-md-12">
        ...
        if ($this->session->flashdata('record_add_msg') != '') {
            echo $this->session->flashdata('record_add_msg');
        }
        ?>
        <form class="form" id="add_record_form" action="<?php echo base_url('/index.php/admin/add_record'); ?>" method="post">
            <div class="row">
                <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="lab_name" class="form-control lab_name">
                            ...
                            if (!empty($get_lab_names) && is_array($get_lab_names)) :
                                foreach ($get_lab_names as $lab_name) {
                                    echo '<option data-labnameid="'.$lab_name->lab_name_id.'" value="' . $lab_name->lab_name . '">' . $lab_name->lab_name . '</option>';
                                }
                            endif;
                            ?>
                    ...
                    <div class="form-group hide_lab_name">
                        <label class="control-label">Lab Number</label>
                        <div class="lab_message"></div>
                        <input type="text" class="form-control" name="lab_number" id="lab_number" placeholder="Lab Number"/>
                    </div>
                    <div class="form-group">  
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="dermatological_surgeon" id="dermatological_surgeon" class="form-control dermatological_surgeon">
                            <option>Please choose dermatological surgeon.</option>
                        </select>
                    </div>
                    <div class="form-group">

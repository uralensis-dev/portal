...
<div class="row">
    <div class="col-md-12">
        <a class="btn btn-primary" href="<?php echo base_url('index.php/admin/show_hospital_clinic_dates'); ?>">Choose Another Hospital</a>
    </div>
</div>
<div class="row">
    <div class="col-md-4 col-md-offset-4">
        ...
        <form action="<?php echo base_url('index.php/admin/add_clinics_date'); ?>" method="post"> 
                ...
                <tbody>
                    ...
                    foreach ($clinic_upcoming as $upcoming) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('index.php/admin/edit_clinic_date/?rec_id=' . $upcoming->ura_clinic_date_id . '&hospital_id=' . $hospital_id . '&ref_key=' . $ref_key); ?>"><img src="<?php echo base_url('assets/img/edit_clinic.png'); ?>"></a></td>
                            <td><a href="<?php echo base_url('index.php/admin/delete_clinic_date/?rec_id=' . $upcoming->ura_clinic_date_id . '&hospital_id=' . $hospital_id); ?>"><img src="<?php echo base_url('assets/img/delete.png'); ?>"></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
                ...
                <tbody>
                    ...
                    foreach ($clinic_previous as $previous) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('index.php/admin/edit_clinic_date/?rec_id=' . $previous->ura_clinic_date_id . '&hospital_id=' . $hospital_id . '&ref_key=' . $ref_key); ?>"><img src="<?php echo base_url('assets/img/edit_clinic.png'); ?>"></a></td>
                            <td><a href="<?php echo base_url('index.php/admin/delete_clinic_date/?rec_id=' . $previous->ura_clinic_date_id . '&hospital_id=' . $hospital_id); ?>"><img src="<?php echo base_url('assets/img/delete.png'); ?>"></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>

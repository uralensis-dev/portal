                                ...
                                <table class="table table-bordered">
                                    ...
                                    foreach ($session_record_data as $key => $value) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="<?php echo base_url('index.php/admin_tracking/SearchTracking/print_session_records_document/'.$value['ura_track_sess_rec_id']); ?>" target="_blank">View PDF Report</a></td>
                                        </tr>
                                    <?php } ?>
                                </table>
                                <?php

                ...
                <div class="col-md-12">
                    ...
                    if (!empty($find_csv_records)) {
                        ...
                        if (isset($_GET['specimen_microscopy'])) {
                            $get_concat_values .= '&specimen_microscopy=' . $_GET['specimen_microscopy'];
                        }
                        if (isset($_GET['specimen_macroscopy'])) {
                            $get_concat_values .= '&specimen_macroscopy=' . $_GET['specimen_macroscopy'];
                        }
                        ...
                        if (isset($_GET['specimen_comments'])) {
                            $get_concat_values .= '&specimen_comment_section=' . $_GET['specimen_comments'];
                        }
                        if (isset($_GET['specimen_notes'])) {
                            $get_concat_values .= '&specimen_special_notes=' . $_GET['specimen_notes'];
                        }
                        ?>
                        ...
                        if (isset($_GET['published_reports'])) {
                            ?>
                            <a href="<?php echo base_url('index.php/admin/download_csv_publish?date_from=' . $date_from . '&date_to=' . $date_to . '&hospital_list=' . $group_id . $get_concat_values); ?>">
                                <button type="submit" class="btn btn-primary">Download</button>
                            </a>
                            <?php
                        } else {
                            ?>
                            <a href="<?php echo base_url('index.php/admin/download_csv_publish_unpublish?date_from=' . $date_from . '&date_to=' . $date_to . '&hospital_list=' . $group_id . $get_concat_values); ?>">
                                <button type="submit" class="btn btn-primary">Download</button>
                            </a>
                            <?php
                        }

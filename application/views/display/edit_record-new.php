										...
										<div class="row">
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Tracking No</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="tracking_no" id="tracking_no" placeholder="Tracking No" value="<?php echo $row->ura_barcode_no; ?>" />
                                     
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Patient Initial</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="patient_initial" id="patient_initial" placeholder="Patient Initial" value="<?php echo $row->patient_initial; ?>" />
                                  
													</div>
												</div>
                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">PCI No</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="pci_no" id="pci_no" placeholder="PCI Number" value="<?php echo $row->pci_number; ?>" />
                                                ...
                                                <div class="form-group row">
													...
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="first_name" id="first_name" placeholder="First Name" value="<?php echo $row->f_name; ?>" />
                                  
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Emis No</label>
													<div class="col-lg-9">
                                                    <input type="text" class="form-control" name="emis_number"  id="nhs_number" placeholder="Nhs Number" value="<?php echo $row->emis_number; ?>" />
                                  
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Lab Number</label>
													<div class="col-lg-9">
                                            ...
                                            ?>
                                                        <input class="form-control datetimepicker" name="dob" id="dob" placeholder="Date of Birth" value="<?php echo $dob; ?>">
                                                </div>
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Importance</label>
													<div class="col-lg-9">
                                                    <select name="report_urgency" class="select">
                                                <?php
                                                ...
                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Case Category</label>
													<div class="col-lg-9">
                                                    <select name="cases_category" class="select">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Lab Rec Date</label>
													<div class="col-lg-9">
                                                    <div class="cal-icon">
                                                    <?php
                                            $lab_rec_date = '';
                                            ...
                                            ?>
                                                        <input class="form-control datetimepicker" name="date_received_bylab" id="date_received_bylab" placeholder="Lab Receiving Date" value="<?php echo $lab_rec_date; ?>">
                                                </div>
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Ura Sent</label>
													<div class="col-lg-9">
                                                    <div class="cal-icon">
                                                    <?php
                                            $date_sent_ura = '';
                                            ...
                                            ?>
                                                        <input class="form-control datetimepicker" name="date_sent_touralensis" id="date_sent_touralensis" placeholder="Uralensis Sent Date" value="<?php echo $date_sent_ura; ?>">
                                                </div>
													</div>
												</div>
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<input type="text" class="form-control" name="sur_name" id="sur_name" placeholder="SurName" value="<?php echo $row->sur_name; ?>">
													</div>
												</div>
												<div class="form-group row">
													<label class="col-lg-3 col-form-label">Nhs Number</label>
													<div class="col-lg-9">
														<input type="text" class="form-control" name="nhs_number"  id="nhs_number" placeholder="Nhs Number" value="<?php echo $row->nhs_number; ?>">
													</div>
												</div>
                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Lab Name</label>
													<div class="col-lg-9">
                                                    <select name="lab_name" class="select lab_name" >
                                            ...
                                            ?>
                                                        <input class="form-control datetimepicker" name="date_taken" id="date_taken" placeholder="Date Taken" value="<?php echo $date_taken; ?>">
                                                </div>
													</div>
												</div>

                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Clinical Req Work</label>
													<div class="col-lg-9">
                                                    <select class="select" readonly name="clrk" id="clrk">
                                                ...
                                                <div class="form-group row">
													<label class="col-lg-3 col-form-label">Derm Surgeon</label>
													<div class="col-lg-9">
                                                    <select readonly name="dermatological_surgeon" id="dermatological_surgeon" class="select">
                    ...
                    <div class="tg-inputshold specimen_content">
                        ...
                        <ul class="nav nav-tabs nav-tabs-top">
                            ...
                            foreach ($specimen_query as $row) :
                                ?>
                                <li class="nav-item"><a class="nav-link" href="#tabs_<?php echo $count; ?>" data-toggle="tab">Specimen <?php echo $count; ?></a></li>
                                <?php
                                $active = '';
                                $count++;
                            endforeach;

...
<div class="page-header">
    <div class="row align-items-center">
		...
		<div class="col-auto float-right ml-auto">
		    <a href="<?php echo base_url('Risk_Register/sub_category_section/0'); ?>" class="btn add-btn"><i class="fa fa-plus"></i>  Add</a>
	    </div>
            ...
            <thead>        
				...
				foreach($result as $row){
				    ...
				    <td>'.date("d/m/Y",strtotime($row['screated_at'])).'</td>'; ?>
                 	<td class="text-right"><a href="<?php echo base_url('Risk_Register/sub_category_section/'.$row['sid']); ?>" ><i class="fa fa-edit m-r-5"></i> </a>
                        <a class="" href="javascript:delete_record('<?= base_url('Risk_Register/delete_sub_category/'.$row['sid']); ?>')" ><i class="fa fa-trash-o m-r-5"></i> </a></td>
				<?php 	
                  echo '</tr>';
				$sn++;
				 }	

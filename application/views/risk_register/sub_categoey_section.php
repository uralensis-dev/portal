    ...
    <div class="row align-items-center">
        <div class="col">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('Risk_Register') ?>">Risk Register</a></li>
			 <li class="breadcrumb-item"><a href="<?php echo base_url('Risk_Register/sub_category_list') ?>">Sub Category</a></li>
							  ...
							  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Category</label>
                                            <select  name="risk_register_category_id" id="risk_register_category_id" value="" class="form-control select">
											
											<option value="">Select Category</option>
										    <?php foreach ($category as $crow) : ?>
												 <?php $category = (isset($result['risk_register_category_id']))?$result['risk_register_category_id']:''; 
										...
										<?php echo  form_error('risk_register_category_id'); ?>
                                        </div>
                                    </div>
		                       ...
		                       <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Name</label>
                                            ...
                                            <input type="text" name="name" id="document_number-input" value="<?php echo (isset($result['name']))?$result['name']:''; ?>" class="form-control" placeholder="Name">

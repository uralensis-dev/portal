...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            <h3 class="page-title">Severity</h3>
            <ul class="breadcrumb">
		...
		<div class="col-auto float-right ml-auto">
		    <a href="<?php echo base_url('Risk_Register/severity_section/0'); ?>" class="btn add-btn"><i class="fa fa-plus"></i>  Add</a>
	    </div>
            ...
            <thead>        
				...
				foreach($result as $row){
				    ...
				    <td>'.date("d/m/Y",strtotime($row['created_at'])).'</td>'; ?>
                 	<td class="text-right"><a href="<?php echo base_url('Risk_Register/severity_section/'.$row['id']); ?>" ><i class="fa fa-edit m-r-5"></i> </a>
                        <a class="" href="javascript:delete_record('<?= base_url('Risk_Register/delete_severity/'.$row['id']); ?>')" ><i class="fa fa-trash-o m-r-5"></i> </a></td>
				<?php 	
                  echo '</tr>';
				$sn++;
				 }	

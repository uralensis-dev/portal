...
<head>
    ...
    <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/css/rota_custom.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/plugins/timepicker/jquery.timepicker.css'); ?>">
    <?php
    if (!empty($styles)) {

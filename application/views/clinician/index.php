...
<div class="row">
    <div class="col-md-offset-3 col-md-6">
        <form class="form" action="<?php echo base_url('index.php/clinician/search_result'); ?>" method="post">
...
<div class="row">
    <div class="col-md-12">
                ...
                <tbody>
                    ...
                    foreach ($result as $reports) {
                        ...
                        <tr>
                            ...
                            <td><a href="<?php echo base_url('index.php/clinician/record_detail/'.intval($reports['uralensis_request_id'])); ?>"><img src="<?php echo base_url('assets/img/detail.png'); ?>" /></a></td>
                        </tr>
                        <?php
                    }
                    ?>
        ...
        <?php } else {
            echo '<div class="alert alert-danger">There is no record assign yet to this logged in clinician.</div>';
        } ?>
    </div>
</div>

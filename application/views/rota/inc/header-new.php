...
<head>
    ...
    <!-- <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/js/calender_new/css/jquery-ui-custom-1.11.2.min.css'); ?>"> -->
    <!-- <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/js/calender_new/css/calenstyle-jquery-ui-override.css'); ?>"> -->
    <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/js/calender_new/css/calenstyle.css'); ?>">
    <link rel="stylesheet"
          href="<?php echo base_url('/assets/newtheme/js/calender_new/css/calenstyle-iconfont.css'); ?>">
    <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/css/rota_custome.css'); ?>">
            ...
            <li class="nav-item dropdown">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <i class="fa fa-comment-o"></i> <span
                            class="badge badge-pill"><?php echo count(getUnreadMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?></span>
                </a>
                <?php

no<?php defined('BASEPATH') OR exit('No direct script access allowed');
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<!--                                            </span>-->
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                ...
                $userinfo = getLoggedInUserProfile(intval($this->ion_auth->user()->row()->id));
                 ...
                 ?>
                        <span class="user-img">
                            <img src="<?php if($userinfo[0]->profile_picture_path != '') echo base_url($userinfo[0]->profile_picture_path); else echo base_url('/assets/img/dummy-doctors.jpg')  ?>" alt="">
            ...
            <div class="sidebar" id="sidebar">
                <div class="sidebar-inner slimscroll">
					<div class="sidebar-menu">
						<ul id="chat_user_area">
							<li> 
								<a href="<?php echo site_url('auth/index'); ?>"><i class="la la-home"></i> <span>Back to Home</span></a>
							</li>
							...
							<li> 
								<a href="#" data-toggle="modal" data-target="#chat_group_<?php echo $rec->id?>">
									<span class="chat-avatar-sm user-img">
										<img class="rounded-circle" alt="" src="assets/img/user.jpg">
									</span> 
									<span class="chat-user">#<?php echo $rec->name?></span>
								</a>
							</li>
                            <?php } ?>
							<!--<li> 
							...
							<li class="menu-title">Online Users <a href="#" data-toggle="modal" data-target="#add_chat_user"><i class="fa fa-plus"></i></a></li>

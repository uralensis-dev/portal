<style type="text/css">
	.chat-main-row{top: -12px; bottom: 12px;}
		...
		<div class="sidebar-menu">
			<ul>
				...
				<li>
					<a href="javascript:;">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url()?>assets/img/profiles/avatar-05.jpg"><span class="status online"></span>
						</span> 
				...
				<li>
					<a href="javascript:;">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url()?>assets/img/profiles/avatar-05.jpg"><span class="status offline"></span>
						</span> 
				...
				<li>
					<a href="javascript:;">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url()?>assets/img/profiles/avatar-05.jpg"><span class="status away"></span>
						</span> 
				...
				<div class="fixed-header">
					<div class="navbar">
						<div class="user-details mr-auto">
							<div class="float-left user-img">
								<a class="avatar" href="profile.html" title="Mike Litorus">
									<img src="<?php echo base_url()?>assets/img/profiles/avatar-05.jpg" alt="" class="rounded-circle">
						...
						<ul class="nav custom-menu">
							...
							<li class="nav-item">
								<a href="javascript:;" class="nav-link"><i class="fa fa-phone"></i></a>
							</li>
							<li class="nav-item">
								<a href="javascript:;" class="nav-link"><i class="fa fa-video-camera"></i></a>
							</li>
				...
				<div class="chat-footer">
					<div class="message-bar">
						<div class="message-inner">
							<a class="link attach-icon" href="#" data-toggle="modal" data-target="#drag_files"><img src="<?php echo base_url()?>assets/img/attachment.png" alt=""></a>

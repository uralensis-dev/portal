...
.page-wrapper.sidebar-patient{
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 requesr-setup" style="padding-left: 30px; padding-right: 30px;">
   ...
   <div class="tg-haslayout filter-setup" style="width: 71%; margin-left: 84px; position: relative; z-index:1;">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                <div class="tg-filterhold">
                    <ul class="tg-filters record-list-filters">
    ...
    <div class="col-md-12 request-form form-group" style="margin-top: -55px;padding-left: 30px; padding-right: 15px;">     
                ...
                if (!empty($requested)) {
                    ...
                    foreach ($requested as $row) {
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                <span class="badge badge-success"><?= $row->test_name; ?></span>
                            </td> -->
                             <td style="text-align: center;">
                            ...
                            <td style="text-align:center">
                                <div class="pull-right">
                                    <a href="<?php echo base_url('doctor/add_further_work_new/') . $row->request_id; ?>" class="dropdown-item"><i class="fa fa-pencil"></i></a>
                                </div>

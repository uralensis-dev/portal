        ...
        <div class="row align-items-center">
            <div class="col">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">View Courier Consignments</li>
                </ul>
            </div>
                        ...
                        <div class="tab-pane active" id="consignment_tab">
                            ...
                            <div class="row mb-3 d-flex align-content-center align-items-center">
                                <div class="col-xl-3">
                                    ...
                                    <ul class="list-inline list-ustyled filters_list mb-0">
                                ...
                                <div class="col-md-12">
                                        ...
                                        if (!empty($couriers)) {
                                            ...
                                            foreach ($couriers as $row) {
                                                ...
                                                <tr class="">
                                                    ...
                                                    <td class=""><?php echo $row['initials'] . "-" . $row['courier_no']; ?><br /><?php echo date("Y-m-d", strtotime($row['created_at'])); ?></td>
                                                    <!--                            <td class="">-->
                                    ...
                                    <img style="border-radius: 50%;width: 25px;height: 25px"
                                         ...
                                         alt="">
                                                        ...
                                                        <span><?php echo $generated_user_id; ?></span>
                                                    ...
                                                    <td class=""><?php echo($row['stamp_date'] == "" ? "" : date("d-m-Y h:i a", strtotime($row['stamp_date']))); ?></td>
                                                    <td class=""><?php echo $row['sender_email']; ?><i class="las la-hospital" title="<?php echo "Address: ".$row['sender_address1']; ?>"></i></td>
                                                    
                                                    <td class=""><?php echo $row['receiver_email']; ?><i class="las la-hospital" title="<?php echo "Address: ".$row['receiver_address1']; ?>"></i></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        //                                }
                                                        ?>
                                                        <!--                                --><?php //if ($user_id == $row['sender_id'] or $user_id == $row['receiver_id']) { ?>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item"
                                                               href=javascript:void(0)"><i
                                                                        class="fa fa-dot-circle-o text-info"></i>Request</a>
                                                            ...
                                                            <?php
                                                            //                                    foreach ($courierStatus as $index => $value) {
                                                            //                                        ?>
                                                            <!--                                        <a class="dropdown-item"-->
                                                            <!--                                           href="-->
                                                            <?php //echo ($index!=0?site_url('addCourier/changeStatus/' . $row['id'] . "/$index"):"javascript:void(0)"); ?><!--"><i-->
                                                            <!--                                                    class="fa fa-dot-circle-o text-info"></i>-->
                                                            <!--                                            -->
                                                            <?php //echo $value; ?><!--</a>-->
                                                            <!--                                    --><?php //}
                                                    ...
                                                    <td class="text-right">
                                                        <div class="dropdown dropdown-action">
                                                            ...
                                                            <textarea id="text_are<?php echo $row['id']; ?>"
                                                                      style="display: none">
                                        <?php
                                        ...
                                        ?>
                                                            ...
                                                            <div class="dropdown-menu dropdown-menu-right">
                                                                <a class="dropdown-item edt-tckt"
                                                                   href="javascript:void(0);"
                                                                   data-id="<?php echo $row['id']; ?>"
                                                                   data-toggle="modal"
                                                                   data-target="#add_courier_modal"><i
                                                                            class="fa fa-pencil m-r-5"></i> Edit</a>
                                                                <a class="dropdown-item del-tckt"
                                                                   href="javascript:void(0);"
                                                                   data-id="<?php echo $row['id']; ?>"
                                                                ...
                                                                <a class="dropdown-item"
                                                                   href="<?php echo base_url() ?>addCourier/trackCourier/<?php echo base64_encode($row['id']) ?>">
                                                                    <i class="fa fa-truck m-r-5"></i> Track</a>

                                                                <a class="dropdown-item" href="<?= base_url() ?>addCourier/stamp_date_add/<?= $row['id']; ?>"><i class="fa fa-check m-r-5"></i> Stamp </a>
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body edt_modal_bdy">
                    ...
                    <input class="form-control floating datepicker_new" type="hidden" name="stamp_date" id="stamp_date" value="<?= date("d-m-Y H:i a") ?>" readonly>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body edt_modal_bdy">
                    <div class="col-md-12">
                        <?php
                        $attributes = array('id' => 'add_courier_company_form');

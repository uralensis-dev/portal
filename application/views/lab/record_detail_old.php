        ...
        <div class="container-fluid" style="padding-right: 130px;">
            <div class="col-md-12 nopadding-right">
                <table class="table custom-table">
                    <tr style="box-shadow:0px 0px 0px 0px !important; border: 1px solid #ddd;">
                        ...
                        <td>
                            <span>DOB: <?php echo !empty($request_query[0]->dob) ? date('d-m-Y', strtotime($request_query[0]->dob)) : ''; ?></span>
                        </td>
                        <td><span>NHS: <?php echo $request_query[0]->nhs_number; ?></span></td>
                        <td>
                            <span>Age/Gender: <?php print @date_diff(date_create($request_query[0]->dob), date_create('today'))->y;?>/<?php $gender = ($request_query[0]->gender == 'Male' ? 'M' : 'F'); ?>
                                <?php echo $gender; ?>
                            </span>
                        </td>
                        <td style="display:none" >
                            ...
                            <span class="btn btn-info btn-sm pull-right btn_save_sec"
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="col-md-12 text-right nopadding-right">
                        <button class="btn btn-info btn-sm btn-rounded btn_collapse_all">Collapse All</button>
                    </div>
                    <?php
                    ...
                    <form class="tg-formtheme" id="doctor_update_personal_record" method="post">
                        <div class="col-md-12 form-group" style="padding-right: 0;">
                            <div class="sec_title p_id form-group">
                                ...
                                <table class="table custom-table info_nndn hidden" style="margin: -15px;">
                            ...
                            <div class="show_save card hidden">
...
<input type="hidden" name="patient_id" id="patient_id" value="<?php echo $row2->id?>" />
                                                            ...
                                                            <div class="table-view-container">
                                                                ...
                                                                <div class="row" data-key="patient_initial">
                                                                    ...
                                                                    <div class="col-sm-9 ">
                                                                        ...
                                                                        <div class="table-view-content"><?php echo $initial; ?></div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="table-view-container">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 ">
                                                                    <div class="table-view-heading">Hospital Name</div>
                                                                    <div class="table-view-content"><?php echo $row2->hospital_id;?></div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="col-sm-3">
                                                        <div class="table-view-container">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 ">
                                                                    <div class="table-view-heading">Patient Usual
                                                                        Address
                                                                    </div>
                                                                    <div class="table-view-content"><?php echo $row2->address_1;?></div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="table-view-container">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-9 ">
                                                                    ...
                                                                    <div class="table-view-content"><?php echo $row2->post_code;?></div>
                                                                </div>
                                                            </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="patient_initial">
                                                            ...
                                                            <input id="patient_initial" type="text"
                                                                   name="patient_initial" class="form_input"
                                                                   placeholder="Patient Initial"
                                                                   value="<?php echo $row->patient_initial; ?>" readonly="readonly">
                                                        </div>
 ...
 <input id="first_name" type="text" name="f_name" class="form_input fname" placeholder="First Name" value="<?php echo $row->f_name; ?>">
                                                        </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="sur_name">
                                                            ...
                                                            <input id="sur_name" type="text" name="sur_name"
                                                                   class="form_input" placeholder="Surname"
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="dob">
                                                            ...
                                                            <input type="text" name="dob" id="dob" class="form_input"
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="nhs_number">
                                                            ...
                                                            <input type="text" class="form_input" id="nhs_number"
                                                                   name="nhs_number" placeholder="Nhs Number"
                                                    ...
                                                    ?>
                                                    <div class="form-group col-md-3">
                                                        <label for="hospital_no">Hospital
                                                            Name.</label>
                                            ...
                                            <select name="hospital_no" id="hospital_no" class="form_input">
                                            <option value="">Choose</option>
                                            <?php foreach($hos_users as $hos) {?>
                                            <option value="<?php echo $hos->id; ?>" <?php if($row->hospital_id=$hos->id) { ?> selected="selected"<?php } ?>><?php echo $hos->description; ?></option>
                                            <?php } ?>
                                            </select>
                                                    ...
                                                    ?>
                                                    <div class="form-group col-md-3">
                                                        <label for="patient_usual_address">Patient
                                                            Usual Address - CR0030</label>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="patient_city">
                                                            ...
                                                            <input type="text" class="form_input" id="patient_city"
                                                                   name="patient_city" placeholder="City" value="<?php echo $row2->city;?>"
                                                                   >
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="postcode">
                                                            ...
                                                            <input type="text" class="form_input" id="postcode"
                                                                   name="postcode" placeholder="Postcode" value="<?php print $row2->post_code;?>">
                                                        </div>
                                                    </div>
                        ...
                        <div class="col-md-12 form-group" style="padding-right: 0;">
                            <div class="sec_title r_id form-group">
                                ...
                                <table class="table custom-table info_nndn2 hidden" style="margin-bottom: 0;">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td><span>Track No: <?php echo $row->ura_barcode_no; ?> </span></td>
                                        <td>
                                        ...
                                        <td>
                                            ...
                                            <span id="save_patient" class="btn btn-info btn-sm pull-right btn_save_sec"
                                                  style="margin-right: 10px; border-radius: 4px;">
                                                <i class="fa fa-save"></i>
                                            </span>
                                            <span class="btn btn-success-outline btn-sm pull-right updated_btn"
                                                  style="margin-right: 10px; border-radius: 4px;">
                                                Updated
                                            </span>
                            ...
                            <div class="show_save card hidden" style="margin-bottom: 0px; ">
                                <div class="card-body">
                                    ...
                                    <div id="table-view-request">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="table-view-content"><?php echo $labNo = $row->request_type; ?></div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            <div class="table-view-heading">Organisation site
                                                                identifier
                                                            </div>
                                            ...
                                            <div class="col-sm-3">
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            <div class="table-view-heading">Organisation identifier
                                                            </div>
                                                            <div class="table-view-content"></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            ...
                                                            <div class="table-view-content">CN-<?php echo $row->record_batch_id; ?></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            ...
                                                            <div class="table-view-content">#<?php echo $row->record_batch_id; ?></div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="track_number">
                                                    ...
                                                    <input type="text" class="form_input" id="track_number"
                                                           name="track_number" placeholder="Track No" value="<?php echo $row->ura_barcode_no; ?>" disabled>
                                                </div>
                                                <label></label>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="specimen_nature">
                                                    ...
                                                    <input type="text" class="form_input" id="specimen_nature"
                                                           name="specimen_nature" placeholder="Specimen Nature" value="<?php echo $labNo = $row->request_type; ?>"
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container"
                                                    ...
                                                    <input type="text" class="form_input"
                                                           ...
                                                           placeholder="Organisation site identifier" value="" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="organisation_identifier">
                                                    ...
                                                    <input type="text" class="form_input" id="organisation_identifier"
                                                           name="organisation_identifier"
                                                           placeholder="Organisation Identifier" value="" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="dermatological_surgeon">Choose Dermatological Surgeon -
                                                    Pcr7100</label>
                                                <div class="form_input_container" data-key="dermatological_surgeon">
                                                    ...
                                                    <select name="dermatological_surgeon" id="dermatological_surgeon"
                                                            class="form_input">
                                                        <option value="">Choose</option>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="location">
                                                    ...
                                                    <input type="text" class="form_input" id="location" name="location"
                                                           placeholder="Location" value="<?php echo $row->location; ?>">
                                                </div>
                                            ...
                                            ?>
                                            <div class="form-group col-md-3">
                                                <label for="surgeon">Surgeon - CR0030</label>
                                                <div class="form_input_container" data-key="surgeon">
                                                    ...
                                                    <input type="text" class="form_input" id="surgeon" name="surgeon"
                                                           placeholder="Surgeon" value="" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="date_taken">
                                                    ...
                                                    ?>
                                                    <input class="form_input" type="text" name="date_taken"
                                            ...
                                            ?>
                                            <div class="form-group col-md-3">
                                                <label for="pathologist">Pathologist -
                                                    Pcr6990</label>
                                                <div class="form_input_container" data-key="pathologist">
                                                    ...
                                                    <input type="text" class="form_input" id="pathologist"
                                                           name="pathologist" placeholder="pathologist" value=""
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="date_received_bylab">
                                                    ...
                                                    ?>
                                                    <input class="form_input" type="text" name="date_received_bylab"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="date_sent_touralensis">
                                                    ...
                                                    ?>
                                                    <input type="text" name="date_sent_touralensis" class="form_input"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="emis_number">
                                                    ...
                                                    <input id="emis_number" type="text" name="emis_number"
                                                           class="form_input" placeholder="Scanner Type"
                                                           value="<?php echo $row->emis_number; ?>">
                                                </div>
                                                <label></label>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="pci_number">
                                                    ...
                                                    <input id="pci_number" type="text" name="pci_number"
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="hospital_code">
                                                    ...
                                                    <input type="text" class="form_input" id="hospital_code"
                                                           name="hospital_code" placeholder="Hospital Code" value=""
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                            <div class="form-group col-md-3">
                                                <label for="request_specialty">Specialty -
                                                    Pcr7130</label>
                                                <div class="form_input_container" data-key="request_specialty">
                                                    ...
                                                    <input type="text" class="form_input" id="request_specialty"
                                                           name="request_specialty" placeholder="Specialty" value=""
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            ?>
                                            <div class="form-group col-md-3">
                                                <label for="specimen_no">Specimen No. -
                                                    Pcr6220</label>
                                                <div class="form_input_container" data-key="specimen_no">
                                                    ...
                                                    <input type="text" class="form_input" id="specimen_no"
                                                           name="specimen_no" placeholder="Specimen No." value=""
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="courier_no">
                                                    ...
                                                    <input type="text" class="form_input" id="courier_no"
                                                           name="courier_no" placeholder="Courier no." value=""
                                                           disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="batch_no">
                                                    ...
                                                    <input type="text" class="form_input" id="batch_no" name="batch_no"
                                                           placeholder="Batch no." value="" disabled>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="report_urgency">
                                                    ...
                                                    <select name="report_urgency" class="form_input "
                                                            id="report_urgency">
                                                        <?php
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="tg-themedetailsicon">
                        <li>
                            <a href="javascript:void(0);" class="tg-detailsicon" data-toggle="modal"
                               data-target="#view_doc" <?php echo(!empty($files && is_array($files)) ? 'onclick="embed_doc()"' : '') ?>
                               title="Related Documents"><span
                                        title="Related Documents"
                                        class="tg-notificationtag"><?php echo count($files); ?></span>
                                <i class="ti-eye"></i>
                            </a>
                            <a href="javascript:void(0);" class="tg-detailsicon" data-toggle="modal"
                               data-target="#capture_webcam" id="capture_webcam_img" title="Capture Image">
                                <i class="ti-camera"></i>
                            </a>
                            <?php if ($request_query[0]->specimen_update_status == 1) { ?>
                                <a href="javascript:;" class="tg-detailsicon tg-filtercolors" title="View Report"
                                   id="show_pdf_iframe">
                            ...
                            <?php if ($request_query[0]->specimen_publish_status == 1) { ?>
                                <a href="<?php echo site_url() . '/doctor/generate_report/' . $request_query[0]->uralensis_request_id; ?>"
                                   target="_blank" class="tg-detailsicon" id="show_pdf_iframe"><i title="View Final PDF"
                                                                                                  class="ti-notepad"></i></a>
                            <?php } ?>
                            <a href="<?php echo site_url() . '/doctor/add_further_work/' . $request_query[0]->uralensis_request_id; ?>"
                               class="tg-detailsicon" title="Add Further Work"><i title="Add Further Work"
                                                                                  class="ti-target"></i></a>
                        ...
                        <li>
                            <a href="javascript:;" class="tg-detailsicon request_for_opinion"
                               title="Request for opinion">
                                <i title="Request for opinion" class="ti-pulse"></i></a>
<!--                            <a href="javascript:;" class="tg-detailsicon" data-toggle="modal" title="Opinion History"-->
<!--                               data-target="#opinion_history_modal"><i class="fa fa-history" title="Opinion History"></i></a>-->
                            <a href="javascript:;" class="tg-detailsicon" data-toggle="modal"
                               title="Assign to other doctor"
                               data-target="#assign_doctor_modal"><i title="Assign to other doctor"
                                                                     class="ti-support"></i></a>
                            <a href="javascript:;" class="tg-detailsicon" data-toggle="modal"
                               title="Assign as teaching and cpc"
                               data-target="#teaching_cpc_modal"><i title="Assign as teaching and cpc"
                                                                    class="ti-bell"></i></a>
                            <?php if ($request_query[0]->specimen_publish_status == 1) { ?>
                                <a href="javascript:;" class="tg-detailsicon" data-toggle="modal"
                                   title="Add Supplementarty Report"
                                   data-target="#add_supplementary"><i title="Add Supplementarty Report"
                                                                       class="ti-plus"></i></a>
                            <?php } ?>
                            <?php if ($request_query[0]->additional_data_state === 'in_session') { ?>
                                <a href="javascript:;" id="publish_supplementary_btn"
                                   title="Publish Supplementarty Report"
                                   data-recordid="<?php echo $request_query[0]->uralensis_request_id; ?>"
                                   class="tg-detailsicon"><i title="Publish Supplementarty Report"
                                                             class="ti-check-box"></i></a>
                            <?php } ?>
                            <a href="javascript:;" class="tg-detailsicon" data-toggle="modal"
                               title="Manage Supplementary"
                               data-target="#manage_supple"><i title="Manage Supplementary"
                                                               class="ti-wallet"></i></a>
                            <!--                            <a href="javascript:;" class="tg-detailsicon lab_email_request" title="Send Email">-->
                            <!--                                <i title="Send Email" class="fa fa-paper-plane"></i></a>-->
                        </li>
                        <li>
                            <a href="javascript:;" class="tg-detailsicon" data-toggle="collapse"
                            ...
                            <a href="<?php echo base_url('/doctor/doctor_record_detail/' . $request_query[0]->uralensis_request_id . '/bridgehead'); ?>"
                               class="tg-detailsicon" title="Related Records">
                                <?php elseif ($request_query[0]->remote_record == 1): ?>
                                <a href="#" class="tg-detailsicon" id="bridgehead-button" title="Related Records">
                                    <?php endif; ?>
                                    <i title="Related Records"><img width="45px"
                                                                    src="<?php echo base_url('assets/img/box.png'); ?>"></i>
                                </a>
                                <!-- Old code 
    <!--                             <a title="Datasets" href="<?php echo site_url('_dataset/breast_cancer_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no)) ?>" class="tg-detailsicon">
                                ...
                                <a class="tg-detailsicon" title="Datasets" data-toggle="modal"
                                   data-target="#datasetLinks"><i class="ti-harddrive" title="Datasets"></i></a>
               ...
               <br><h3><a title="Basal Cell Carcinoma" href="<?php echo site_url('_dataset/basal_cell_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no)) ?>">
                                 <i class="ti-harddrive" title="Basal Cell Carcinoma"></i> Basal Cell Carcinoma</a></h3>
                                                ...
                                                <ul class="nav nav-tabs" role="tablist">
                                                    ...
                                                    foreach ($specimen_query as $sq) {
                                                        ?>
                                                        <li role="presentation"><a href="#Specimen<?= $sqCount ?>DS"
                                                                                   aria-controls="Specimen<?= $sqCount ?>DS"
                                                                                   role="tab"
                                                                                   data-toggle="tab">Specimen <?= $sqCount ?></a>
                                                        </li>
                                                        <?php
                                                        $sqCount++;
                                                    }
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    foreach ($specimen_query as $sq) {
                                                        ?>
                                                        <div role="tabpanel"
                                                             class="tab-pane <?= $sqCountt == 1 ? 'active' : '' ?>"
                                                             id="Specimen<?= $sqCountt ?>DS"> <?php
                                                            foreach (get_Datasets() as $ds) {
                                                                ...
                                                                if ($ds->parent_dataset_id > 0) {
                                                                    ...
                                                                    if ($ds->dataset_id == 14) {
                                                                        ?>
                                                                        <a title="Breast Cancer"
                                                                           href="<?php echo site_url('_dataset/breast_cancer_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no) . '/' . urlencode($ura_dob) . '/' . urlencode($ura_nhs) . '/' . urlencode($ura_gender) . '/' . urlencode($labNo)) . '/' . $sqCountt ?>"> <?= $ds->dataset_name ?>  </a>

                                                                    <?php } else if ($ds->dataset_id == 18) { ?>
                                                                        <a title="Basal Cell Carcinoma"
                                                                           href="<?php echo site_url('_dataset/basal_cell_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no) . '/' . urlencode($ura_dob) . '/' . urlencode($ura_nhs) . '/' . urlencode($ura_gender) . '/' . urlencode($labNo)) . '/' . $sqCountt ?>"> <?= $ds->dataset_name ?>  </a>
                                                                    <?php } else if ($ds->dataset_id == 19) { ?>
                                                                        <a title="Basal Cell Carcinoma"
                                                                           href="<?php echo site_url('_dataset/cutaneous_malignant_melanoma_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no) . '/' . urlencode($ura_dob) . '/' . urlencode($ura_nhs) . '/' . urlencode($ura_gender) . '/' . urlencode($labNo)) . '/' . $sqCountt ?>"> <?= $ds->dataset_name ?>  </a>
                                                                    <?php } else if ($ds->dataset_id == 21) { ?>
                                                                        <a title="Basal Cell Carcinoma"
                                                                           href="<?php echo site_url('_dataset/squamous_cell_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no) . '/' . urlencode($ura_dob) . '/' . urlencode($ura_nhs) . '/' . urlencode($ura_gender) . '/' . urlencode($labNo)) . '/' . $sqCountt ?>"> <?= $ds->dataset_name ?>  </a>
                                                ...
                                                <?php /* ?>                                         
                                                  ...
                                                  <!-- Nav tabs -->
                                                  <ul class="nav nav-tabs" role="tablist">
                                                  <li role="presentation"><a href="#Specimen1DS" aria-controls="Specimen1DS" role="tab" data-toggle="tab">Specimen 1</a></li>
                                                  <li role="presentation"><a href="#Specimen2DS" aria-controls="Specimen2DS" role="tab" data-toggle="tab">Specimen 2</a></li>
                                                  </ul>

                                                  <!-- Tab panes -->
                                                  <div class="tab-content">
                                                  <div role="tabpanel" class="tab-pane active" id="Specimen1DS"> <?php
                                                  foreach (get_Datasets() as $ds) {
                                                  if ($ds->parent_dataset_id == 0) {
                                                  echo "<div class='pDs'><i class='fa fa-chevron-right pDs'></i>" . $ds->dataset_name . "</div>";
                                                  }
                                                  ...
                                                  if ($ds->dataset_id == 14) {
                                                  ?>
                                                  <a title="Breast Cancer" href="<?php echo site_url('_dataset/breast_cancer_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no)) ?>"> <?= $ds->dataset_name ?>  </a>

                                                  <?php } else if ($ds->dataset_id == 18) { ?>
                                                  <a title="Basal Cell Carcinoma" href="<?php echo site_url('_dataset/basal_cell_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no). '/' . urlencode($ura_dob). '/' . urlencode($ura_nhs). '/' . urlencode($ura_gender). '/' . urlencode($labNo)).'/1' ?>"> <?= $ds->dataset_name ?>  </a>
                                                  ...
                                                  ?> </div>
                                                  <div role="tabpanel" class="tab-pane" id="Specimen2DS"> <?php
                                                  foreach (get_Datasets() as $ds) {
                                                  if ($ds->parent_dataset_id == 0) {
                                                  echo "<div class='pDs'><i class='fa fa-chevron-right pDs'></i>" . $ds->dataset_name . "</div>";
                                                  }
                                                  ...
                                                  <?php } else if ($ds->dataset_id == 18) { ?>
                                                  <a title="Basal Cell Carcinoma" href="<?php echo site_url('_dataset/basal_cell_dataset/dashboard/' . $this->uri->segment(3) . '/' . urlencode($initial) . '/' . urlencode($fullname) . '/' . urlencode($serial_number) . '/' . urlencode($ura_barcode_no). '/' . urlencode($ura_dob). '/' . urlencode($ura_nhs). '/' . urlencode($ura_gender). '/' . urlencode($labNo).'/2') ?>"> <?= $ds->dataset_name ?>  </a>
                        ...
                        <li class="tg-reloadoption" style="display: none">
                            <a href="javascript:;"
                               class="tg-detailsicon disable tg-themeiconcolorone make_editable"><i class="ti-power-off"
                                                                                                    data-toggle="tooltip"
                                                                                                    data-placement="top"
                                                                                                    title="Enable/Disable Fields"></i></a>
                            <?php
                            $button_disable = '';
                            ...
                            <a href="javascript:;" <?php echo $button_disable; ?>
                               class="tg-detailsicon update_doctor_personal_report_btn"
                               id="update_doctor_personal_report_btn"><i class="ti-reload"></i></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script>
    ...
    $(document).ready(function () {
        $(".btn_collapse_all").click(function(){
            $(".card").addClass("show");
            $(".checv_up_down .fa").removeClass("fa-chevron-down");
            $(".checv_up_down .fa").addClass("fa-chevron-up");
            $(".make_editable").addClass("show");
        });

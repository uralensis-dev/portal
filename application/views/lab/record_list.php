				...
				<?php if ($sr_specialty != '') {
					...
					<tr class="<?php //echo $row_code; 
						...
						<td style="text-align:right; padding-right: 10px;">
							...
							<a class="delete_record" data-custom_url="<?php echo site_url() . '/lab/delete_record/' . $row->uralensis_request_id . $request_type; ?>" href="javascript:void(0)"><i class="fa fa-trash-o m-r-5"></i> </a>

...
<style type="text/css">
    ...
    .comments_icon{position: relative;}
...
<!--                        </li>-->
                        <li class="tg-statusbar tg-flagcolor custome-flagcolors nobefore search_li" style="padding: 0">
                                ...
                                echo form_open('doctor/doctor_opinion_cases', $attributes); ?>
                            <div class="input-group">
                                <select name="sr_opinion_status" class="form-control" onchange="search_by_type()">
                            ...
                            <div class="comments_icon">
                                ...
                                if(!empty($row->ura_rec_opinion_status)){
                                    ...
                                    if($opinion_status=='Pending'){
                                        ...
                                        <?php
                                        $attributes = array('method' => 'POST',"class"=>"update_opinion");
...
<!--                                         <button class=" btn btn-info btn-sm btn-rounded"></button> -->
                                        ...
                                        <div class="dropdown">
                                            <a href="#" title="Pending" style="color:#000;" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right" style="border:0px;">
                                                <a style="color:#000; margin-bottom: 5px;" class="opinion_status_btn opinion_accept_status_btn" href="javascript:void(0)" >

                                                    <i class="fa fa-dot-circle-o text-success" style="font-size: 18px; color: <?php echo $badge_color; ?>;"></i> Accept
                                                ...
                                                <i class="fa fa-dot-circle-o text-danger" style="font-size: 18px; color: <?php echo $badge_color; ?>;"></i> Decline
    <!--                                            <span class="badge  --><?php //echo $badge_color; ?><!--">--><?php //echo $status_text; ?><!--</span>-->
                                            </a>
                                    ...
                                    <?php }else{
                                        ...
                                        }elseif($opinion_status == 'Declined'){
                                            $badge_color = "#f62d51";
...
<!--                            --><?php //echo $row->ura_opinion_last_date; ?>
                        ...
                        <td>
                            <a  class="edit-icon" href="<?php echo $a_href; ?>" title="<?php echo ($a_href=="javascript:void(0);"?"Please Accept/Decline request":"");?>">
...
<!--                        </td>-->
                        <td>
                            <div class="comments_icon" style="position: relative">
                                <?php
                                $opinion_status = "";
                                $badge_color = "";
                                $status_text = "";
                                ...
                                ?>
                                        <span class="badge badge-pill opinion_count alloc-circle bg-warning text-white" title="Pending"><?php echo $opinion_status_req['pending_count']; ?></span>
                                        <span class="badge badge-pill opinion_count alloc-circle bg-success text-white" title="Accepted"><?php echo $opinion_status_req['accepted_count']; ?></span>
                                        <span class="badge badge-pill opinion_count alloc-circle bg-danger text-white" title="Declined"><?php echo $opinion_status_req['rejected_count']; ?></span>
                                        <span class="badge badge-pill opinion_count alloc-circle bg-info text-white" title="Replied"><?php echo $opinion_status_req['replied_count']; ?></span>
                                        <span class="badge badge-pill opinion_count alloc-circle bg-primary text-white" title="Total"><?php echo $opinion_status_req['total']; ?></span>

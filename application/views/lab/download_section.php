...
<div class="row">
    <div class="col-md-12">
        ...
        ?>
        <form method="post" class="form-inline" enctype="multipart/form-data" action="<?php echo base_url('index.php/doctor/do_upload_download_section/' . $record_id); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if ($doctor_id == $file->user_id) : ?>
                                    <a href="<?php echo site_url() . '/doctor/delete_download_section_files?file_id=' . $file_id.'&record_id='.$record_id; ?>">

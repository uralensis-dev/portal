    ...
    <div class="col-lg-6 col-xl-7">
        <div class="card">
            <div class="card-body">
                ...
                <?php
                $attributes = array('id'=>'saveFurtherRequest');
                ...
                <div class="col-lg-12 form-group">
                    <div class="row">
                        ...
                        <div class="col-lg-5 form-group">
                            <input type="hidden" name="group_id" id="group_id" class="form-control"  value="<?php echo $request_query[0]->hospital_group_id;?>" readonly>
                            <input type="hidden" name="request_id" id="request_id" class="form-control"  value="<?php echo $request_query[0]->uralensis_request_id;?>" readonly>
                            <input type="text" name="lab_number" id="lab_number" class="form-control" placeholder="Lab No." value="<?php echo $request_query[0]->lab_number;?>" readonly>
                        </div>
                        <div class="col-lg-5 form-group">
                            <ul class="list-inline text-right specimen_list">
                                <?php
                                $tempArr = array_unique(array_column($specimen_blocks, 'specimen_no'));
                                $uniqueColums = array_intersect_key($specimen_blocks, $tempArr);
                                foreach ($uniqueColums as $uniqueColum) { ?>
                                    <li class="speci-list list-inline-item s_list" data-text="Specimen 1">
                                        <a href="javascript:;" class="inner_specimen"><?php echo $uniqueColum->specimen_no; ?></a>
                                        <ul class="list-inline specimen_list_inners">
                                            <?php foreach ($specimen_blocks as $sp_block) {
                                                if ($sp_block->specimen_no == $uniqueColum->specimen_no) {
                                                    ?>
                                                    <li class="list-inline-item" data-text="Specimen 1">
                                                        <a href="javascript:;" data-specimen-id="<?php echo $sp_block->id; ?>" data-specimen-text="<?php echo $sp_block->specimen_no; ?>" data-block-text="<?php echo $sp_block->block_no . $sp_block->description; ?>"
                                                           class=""><?php echo $sp_block->block_no . $sp_block->description; ?></a>
                                                    </li>
                                                <?php }
                                            } ?>
                                        </ul>
...
<!--                                </li>-->
                    ...
                    <?php if(is_array($complete_records) && !empty($complete_records)){ ?>
                        <?php foreach($complete_records as $first_level_key => $first_level_records){ ?>
                            <div class="tab-pane show <?php echo ($first_level_key == 0)? 'active' : ''; ?>" id="<?php echo 'tab-'.$first_level_key; ?>">
                                ...
                                <?php }elseif ($first_level_records['has_level'] == 1) { ?>
                                    <div class="row m-0">
                                ...
                                <?php } elseif ($first_level_records['has_level'] == 2){ ?>
                                    <div class="form-group">
                                        <?php if(is_array($first_level_records['nodes']) && !empty($first_level_records['nodes'])){ ?>
                                            <?php foreach($first_level_records['nodes'] as $second_level_key => $second_level_record){ ?>
                                                <div class="row m-0">
                ...
                <div class="form-group mt-5">
                    ...
                    <div class="row">
                        <div class="col-sm-6 form-group">
                            ...
                            <input type="number" name="num_of_levels" id="num_of_levels" class="form-control" min="0">
                        </div>
                        <div class="col-sm-6 form-group">
                            <label>Last Previous Level</label>
                            <input type="number" name="last_pre_levels" id="last_pre_levels" class="form-control">
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-12 form-group">
                        ...
                        <input type="text" class="form-control"  name="request_reason" id="myInput" value="">
                    </div>
                    <div class="col-lg-12 form-group">
                        <label>Comments</label>
                        <input type="text" class="form-control" name="request_comment" id="myInput2" value="">
                    </div>
                </div>
                <?php echo form_close();?>
    ...
    <div class="col-lg-6 col-xl-5">
        ...
        <div class="card print_section" style="width: 100%">
            ...
            <div class="card-footer text-right">
                <div class="row">
                    <div class="col-lg-12 form-group">
                        <button class="btn btn-primary save-btn-furtherwork">  Save </button>

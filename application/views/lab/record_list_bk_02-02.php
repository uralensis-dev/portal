          ...
          foreach ($query as $row) 
          {
            ...
            {}else{ ?>
                <tr class="<?php //echo $row_code; ?>" onclick="window.location.href=<?php echo site_url() . '/doctor/doctor_record_detail_old/' . $row->uralensis_request_id.$request_type; ?>">
                  ...
                  <td class="<?php // echo $row_code; ?>">
				  <a title="Edit" href="<?php echo site_url() . '/doctor/doctor_record_detail_old/' . $row->uralensis_request_id.$request_type; ?>"><?php echo $row->lab_number; ?></a><br><?php echo $row->ura_barcode_no; ?></td>
                  <td>
                    <?php
                    $f_initial = '';
                    $l_initial = '';

  ...
  <div class="container-fluid">
    ...
    <div class=" report_listing" id="report-list-table">
      ...
      <table id="doctor_record_list_table" class="table table-striped custom-table mb-0 dataTable no-footer" cellspacing="0" width="100%" style="margin-top:1px !important">
        <thead>
          <tr>           
            <th style="width:80px;"><img data-toggle="tooltip" title="Pathologist" style="max-width:30px;" src="<?php echo base_url('/assets/icons/Pathologist.png'); ?>" class="img-responsive"></th>
            <th><img data-toggle="tooltip" title="Pathologist" style="max-width:30px;" src="<?php echo base_url('/assets/icons/track.png'); ?>" class="img-responsive"></th>
            <th style="width:60px;"><img data-toggle="tooltip" title="Pathologist" style="max-width:40px;" src="<?php echo base_url('/assets/icons/hospital-admin.png'); ?>" class="img-responsive"></th>
            <th><i class="la la-truck"></i></th>
            <th><img data-toggle="tooltip" title="Pathologist" style="max-width:40px;" src="<?php echo base_url('/assets/icons/lab_accounts.svg'); ?>" class="img-responsive"></th>
            <th><i class="la la-stethoscope"></i></th>
             <th class="status_up" style="text-align:left!important;">
             <img data-toggle="tooltip" title="Pathologist" style="max-width:34px;" src="<?php echo base_url('/assets/icons/Pathologist-new.png'); ?>" class="img-responsive">
            </th>
            <th><img data-toggle="tooltip" title="Pathologist" style="max-width:33px;" src="<?php echo base_url('/assets/icons/U-mskcc.png'); ?>" class="img-responsive"></th>
            ...
            <th><img data-toggle="tooltip" title="Pathologist" style="max-width:30px;" src="<?php echo base_url('/assets/icons/invoices.png'); ?>" class="img-responsive"></th>                  
            <th>TAT</th>
            
            <th  class="text-right">
              <img data-toggle="tooltip" title="Actions" style="max-width:30px;" src="<?php echo base_url('/assets/icons/Actions-Blue.png'); ?>" class="img-responsive pull-right">
            </th>

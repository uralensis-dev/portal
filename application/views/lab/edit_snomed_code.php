    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <?php
                ...
                } elseif($snomed_type === 's') {
                    $title = 'Short Code';
                    $desc  = 'Short Code Description';
                }
            if($snomed_type === 's') {
                $snomed_code_val = !empty($snomed_result['umc_code']) ? $snomed_result['umc_code'] : '';
                $snomed_desc_val = !empty($snomed_result['umc_micro_desc']) ? $snomed_result['umc_micro_desc'] : '';
                $snomed_diagnoses = !empty($snomed_result['umc_disgnosis']) ? $snomed_result['umc_disgnosis'] : '';
                $rc_path_score = !empty($snomed_result['umc_rcpath_score']) ? $snomed_result['umc_rcpath_score'] : '';
            }else{
            ...
            ?>
            <a class="btn btn-primary" href="<?php echo base_url('doctor/showSnomedCodes'); ?>">Go back<<<</a>
            <div class="row">
                <div class="col-md-6 col-md-offset-3">
                    <?php echo form_open("doctor/updateSnomedCode", array('class' => 'form edit_snomed_form')); ?>
                        ...
                        <?php if($snomed_type === 'm' || $snomed_type === 's') { ?>
                            <div class="form-group">

...
<div class="row">
    ...
    <?php endif; ?>
    <div class="col-sm-12 col-md-<?php echo  empty($group_menu) ? 12 : 8; ?>">
            ...
            <table class="table datatable table-striped">
                ...
                <?php foreach ($requests as $request): ?>
                    <tr>
                        ...
                        <td><?php echo  $request->specimen_rcpath_code; ?></td>
                        <td class="text-right"><a href="<?php echo  site_url('/allocator/view_singlerecord/' . $request->uralensis_request_id); ?>" class="btn btn-link text-primary">
                ...
                <tr>
                    ...
                    <td><a href="<?php echo  site_url('/allocator/needs_attention/' . $specialty->specialty_id); ?>">Needs Attention</a> </td>

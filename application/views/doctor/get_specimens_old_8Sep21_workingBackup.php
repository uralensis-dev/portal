                    ...
                    <form class="tg-formtheme tg-tabform tg-tabformvtwo doctor_update_specimen"
                        ...
                        if (!empty($get_bcc_record)) {
                            for ($clinical_arr = 0; $clinical_arr < sizeof($get_bcc_record); $clinical_arr++) {
                                ...
                                ?>
                                <div id="dscd_<?= $get_bcc_record[$clinical_arr]['patient_specimen'] ?>" style="display:none">
                                    <div class="col-md-12 nopadding">
                                        <div class="sec_title form-group">
                                            ...
                                            <div id="demo" class="collapse">
                                                <fieldset class="tg-tabfieldsettwo">
                                                    <button type="button" class="btn btn-info block_model_btn_<?php echo $inner_tab_count; ?>"
                                                            ...
                                                            data-specimenprefix ="<?php echo $prefixes_data['specimen_prefix']; ?>"
                                                            data-specimenblkprefix ="<?php echo $prefixes_data['specimen_block_prefix']; ?>"
                        ...
                        <div class="">
                            ...
                            if (!empty($get_bcc_record)) {
                                for ($clinical_arr = 0; $clinical_arr < sizeof($get_bcc_record); $clinical_arr++) {
                                    ...
                                    ?>
                                    <div>
                                        <div id="dsma_<?= $get_bcc_record[$clinical_arr]['patient_specimen'] ?>" style="display:none">
                                            <div class="col-md-12 nopadding">
                                                <div class="sec_title form-group">
                        ...
                        <div class="">
                            ...
                            if (!empty($get_bcc_record)) {
                                for ($clinical_arr = 0; $clinical_arr < sizeof($get_bcc_record); $clinical_arr++) {
                                    ...
                                    ?>
                                    <div>
                                        <div id="dsmi_<?= $get_bcc_record[$clinical_arr]['patient_specimen'] ?>" style="display:none">
                                            <div class="col-md-12 nopadding">
                                                <div class="sec_title form-group">
    ...
    <script>
        $(document).ready(function () {
            ...
            $(blocks_wrapper_add_btn).click(function (e) { //on add input button click
                ...
                // block_inner_tab = ++block_inner_tab;
                ...
                $(blocks_wrapper).append('' +
                        ...
                        '<div class="col-md-2"> <div class="form-group form-focus"> <input type="text" class="form-control floating" name="block_no_of_blocks[]" value="' + block_specimen_tab + '' + block_inner_tab + '" readonly>  <label class="focus-label" >Block No.</label> </div> </div>' +
                ...
                $('#block_inner_tab').val(block_specimen_tab + block_inner_tab);

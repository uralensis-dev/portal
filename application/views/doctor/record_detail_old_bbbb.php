            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                ...
                <div class="tg-breadcrumbarea tg-searchrecordhold">
                    ...
                    <div class="col-md-3 style="padding-left: 15px;">
                        <h3 class="page-title">Records jflkdjfkldsfjkldsfjsklfjdsfklds</h3>
                        <ul class="breadcrumb">
                                ...
                                <table class="table custom-table info_nndn2" style="margin-bottom: 0;">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        <td>
                                            ...
                                            <span  style="font-weight: 500; display:inline-block; margin-top: 12px;"><?php echo $p_result[0]->first_name; ?> <?php print $p_result[0]->owner_name; ?></span>
                                        </td>
                                        <td>
                                            <span style="font-weight: 500">Patient: <?php echo $p_result[0]->first_name; ?> <?php print $p_result[0]->last_name; ?> </span>
                                        </td>
                                        <td>
                                            <span style="font-weight: 500">Sex: <?php print $p_result[0]->gender; ?></span>
                                        </td>
                                        <td><span style="font-weight: 500">DOB: <?php print $request_query[0]->dob;?> / <?php print @date_diff(date_create($request_query[0]->dob), date_create('today'))->y;?> y</span></td>
                                       <td>
                                        ...
                                        <td>
                                            <span class="edit_icon pull-right make_editable p_id_icon"
                                                        ...
                                                        <div class="col-sm-6 nopadding">
                                                            <div class="table-view-container">
                                                                ...
                                                                <div class="row" data-key="patient_initial">
                                                                    ...
                                                                    <div class="col-xs-9 ">
                                                                        <div class="table-view-heading">Name</div>
                                                                        <div class="table-view-content"><?php print $p_result[0]->first_name; ?></div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <div class="col-sm-6 nopadding">
                                                            <div class="table-view-container">
                                                                ...
                                                                <div class="row" data-key="gender">
                                                                    ...
                                                                    <div class="table-view-content"><?php print $p_result[0]->last_name; ?></div>
                                                                </div>
                                                                </div>
                                                ...
                                                <fieldset>
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="sur_name">
                                                            ...
                                                            <input id="sur_name" type="text" onblur="save_case_request(this.id)" name="sur_name"
                                                                   class="form_input" placeholder="Surname"
                                                                   value="<?php print $p_result[0]->last_name; ?>">
                                                        </div>
                                                        <!-- <label></label> -->
...
?>
                                ...
                                <table class="table custom-table info_nndn2" style="margin-bottom: 0;">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td><span style="font-weight: 500">Request ID: <?php echo $row->lab_number;?></span></td>
                                        <td><span style="font-weight: 500">Pathologist: <span><img src="<?php echo base_url();?><?php echo $Usersgetdatils[0]->profile_picture_path;?>" class="img-fluid img-circle" width="40" title="<?php echo $Usersgetdatils[0]->first_name;?> <?php echo $Usersgetdatils[0]->last_name;?>"></span></span></td>
                                        ...
                                        <td class="text-right">
                                            <span class="pull-right edit_icon make_editable r_id_icon" style="margin-right: 25px; display:none;">
                                                <i class="fa fa-pencil"></i>
                                            </span>
                                            <!-- <span class="btn btn-info btn-sm pull-right btn_save_sec hidden" id="save_patient" style="margin-right:10px; border-radius:4px;">
                                                <i class="fa fa-save"></i>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-9 ">
                                                            ...
                                                            <div class="table-view-content"><?php echo $hospital_infodata[0]->site_identifier;?></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-xs-9 ">
                                                            ...
                                                            <div class="table-view-content"><?php echo $hospital_infodata[0]->identifier;?></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row" data-key="date_received_bylab">
                                                        ...
                                                        <div class="col-xs-9 ">
                                                            ...
                                                            if (!empty($row->date_received_bylab)) {
                                                                $date_received_bylab = date('d-m-Y', strtotime($row->request_datetime));
                                                            }
                                                            ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="lab_number">
                                                    ...
                                                    <input type="text" onblur="save_case_request(this.id)" class="form_input" id="lab_number"
                                                    ...
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <div class="form_input_container" data-key="hospital_no">
                                                            <div class="radial_btn_container change_status_color">
                                                             ...
                                                             <select class="form_input hos_name" id="hos_id" onchange="save_case_request(this.id)" name="hos_id">
                                                        <option value="0">Choose</option>
                                                       
                                                        <?php
                                                        $get_hos_names = $this->Doctor_model->display_hospitals_list();
                                                        if (!empty($get_hos_names) && is_array($get_hos_names)) :
															...
															{																
                                                                ...
                                                                echo '<option data-labnameid="' . $hos_val->id . '" ' . $selected . ' value="' . $hos_val->id . '">' . ucwords($hos_val->description) . '</option>';
                                                            }
                                                        endif;
                                                        ?>                                                        
                                                    </select>
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="dermatological_surgeon">Clinician</label>
...
//$hospital_id = 87;
                    get_specimens($specimen_query, $request_query, $request_query[0]->uralensis_request_id, $get_cost_codes['cost_codes'], $opinion_data, $specimen_accepted_by, $specimen_assisted_by, $specimen_block_checked_by, $specimen_cutup_by, $specimen_labeled_by, $specimen_qcd_by, $slide_data, $specimen_blocks, $testListArr);
                    ?>
                </div>
            </div>
        </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".checv_up_down .la-eye").click(function(){

...
<div class="col-md-12 nopadding">
                                ...
                                <div class="card-body">
                                    <fieldset class="tg-tabfieldsettwo">
                                        ...
                                        <div id="macroscopic-description-container"
                                            ...
                                            <div id="" class=""  style="border-top:1px solid #ddd; margin-top: 15px; padding-top: 15px; margin-bottom: 15px">
                        ...
                        <div class="col-md-12 nopadding form-group">
                            <div class="sec_title form-group">
                                Block/Test ID <a href="javascript:;" class="checv_up_down"><i
                                        class="fa fa-chevron-up"></i></a>
                            </div>
                            <div class="card hidden show">
                                <div class="card-body">
                        ...
                        <div class="col-md-12 test_area form-group nopadding" style="display:none !important">
                                            ...
                                            <fieldset>
                                                <div class="microscopy-form-container form-group ">
                                                    ...
                                                    <textarea novalidate
                                                              ...
                                                              name="specimen_microscopic_description2"
                                                        ...
                                                        <div class="d-flex flex-column comment-section">
                                                            <div class="bg-light p-2">
                                                                ...
                                                                <div class="d-flex flex-row align-items-start mb-3">
                                                                    ...
                                                                    <img class="rounded-circle user_image"
                                                                         ...
                                                                         width="40">
                                                                    <textarea class="form-control ml-1 shadow-none textarea" id="flag_commentss"
                                                                              name="flag_commentss" style="padding-left: 60px;"></textarea>
                                                                </div>
                                                                <div class="clearfix"></div>
...
<!--                                                    <a style="color:#000;" href="javascript:;" class="display_comment_box" data-recordid="--><?php //echo $row->request_id; ?><!--">-->
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).on("click",".post_comment_btn",function () {
                ...
                var edit_com_id = $("#edit_com_id").val();

                $.ajax({
                    type: "POST",
                    url: _base_url + '/doctor/save_flag_comments/',
                    data:  {[csrf_name]: csrf_hash,task_comment_id: dataId,data_section: dataSection,flag_comment: flag_comment,edit_status: edit_status,edit_com_id: edit_com_id},
                    dataType: "json",
                    success: function (response) {
                        if (response.status === 'success') {
            ...
            $(document).on("click",".edit-comment-btn",function () {
                ...
                $("#flag_commentss").val(comment_text);
                $(".cancel-com-btn").show();
            });

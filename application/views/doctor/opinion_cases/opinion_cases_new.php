...
.unbond-table{
    ...
    @media screen and (min-width: 1380px) {
        ...
        div.dataTables_wrapper div.dataTables_length select{top: -55px;}
    }
...
<div class="content container-fluid">
    ...
    <div class="tg-haslayout">
        ...
        <?php } ?>
        <div class="row">
            <div class="col-sm-11 col-md-11 col-lg-11" style="float: right;">
...
<!--                        </li>-->
    ...
    <div class="row report_listing">
        <div class="col-md-12">
            ...
            <table id="doctor_opinion_record_list_table"  class="table table-responsive table-striped custom-table" cellspacing="0" style="width:100%; margin-top:40px; overflow: scroll;">
                <thead>
                <tr>
                    <th>Specimen Type</th>
            ...
            <table id="doctor_opinion_requested_list_table"  class="table table-responsive table-striped custom-table" cellspacing="0" style=" overflow: scroll;">
                ...
                foreach ($opinion_cases_requested as $row) {
                    ...
                    <tr class="<?php //echo $row_code; ?>">
                        <td><?php echo $row->spec_grp_name; ?></td>
                        <td class="<?php // echo $row_code; ?>"><?php echo $row->serial_number; ?><br><?php echo $row->ura_barcode_no; ?></td>
                        <td width="50" class="table-set-width">
                            <?php
                            $f_initial = '';
                            $l_initial = '';
                            if (!empty($this->ion_auth->group($row->hospital_group_id)->row()->first_initial)) {
                       ...
                       <div class="main-div">
                        <!-- <td class="text-center">&nbsp;</td> -->
                        <div class="flag_column text-center">
                        <div class="div23 <?php echo $urgency_class; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $urgency_title; ?>" style="font-size:18px;">
                        </div>
                            <div class="div23 hover_flags">
                                <div class="flag_images">
                                    <?php if ($row->flag_status === 'flag_red') { ?>
                                        <img data-toggle="tooltip" data-placement="top" title="This case marked as urgent." class="report_selected_flag" src="<?php echo base_url('assets/img/flag_lg_red.png'); ?>">
                                    <?php } elseif ($row->flag_status === 'flag_yellow') { ?>
                            ...
                            <div class="div23"><img src="<?php if ($has_slide) echo base_url('/assets/icons/vslideico_green.png'); else echo base_url('/assets/icons/vslideico.png'); ?>" style="<?php if ($has_slide) echo 'width: 25px;'?>" class="img-responsive vslideico"></div>
                        
                            <div class="div23 comments_icon">
                                <a style="color:#000;" href="javascript:;" id="display_comment_box" class="display_comment_box" data-recordid="<?php echo $row->uralensis_request_id; ?>" data-modalid="<?php echo $flag_count; ?>">
                                    <i class="lnr lnr-bubble" style=""></i>
                                </a>
                            </div>
...
<!--                        </td>-->
                        <td>
                            <div class="comments_icon borderset">
                                <?php
                                $opinion_status = "";
                                $badge_color = "";
                                $status_text = "";

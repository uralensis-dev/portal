...
.tg-searchrecordhold{padding: 0;}
    ...
    .table.custom-table .comments_icon .lnr{
                                    ...
                                    <li class="tg-statusbar tg-flagcolor">
                                        <div class="tg-checkboxgroup tg-checkboxgroupvtwo">
                                            ...
                                            <span title="<?php echo $hospital['description']?>" class="tg-radio tg-flagcolor1">
                                                <?php $initialVal = $hospital['first_initial'].$hospital['last_initial']; ?>
                                                <input value="<?= $initialVal; ?>" class="filter_by_hospital_btn" name="hostpital" id="<?= $initialVal; ?>" type="radio" <?= ($hospital_id == $hospital['id']) ? 'checked' : ''; ?>>
                                                <label for="<?= $initialVal; ?>"><span><?= $initialVal; ?></span></label>
                                            </span>
                                            <?php endforeach; ?>
                ...
                <div class="tg-filterhold">
                    <ul class="tg-filters record-list-filters">
                        ...
                        <li class="tg-statusbar tg-flagcolor" style="padding: 5px">
                            <div class="tg-checkboxgroup tg-checkboxgroupvtwo">
                                <span class="tg-radio tg-flagcolor1" title="All View">
                                    <input type="radio" class="data_type" name="data_type" value="all" id="type1" title="View All" checked>
                                    <label for="type1">All</label>
                                </span>
                                <span class="tg-radio tg-flagcolor2" title="Assigned">
                                    <input type="radio" class="data_type" name="data_type" value="assigned" id="type2">
                                    <label for="type2">AS</label>
                                </span>
                                <span class="tg-radio tg-flagcolor3" title="Unassigned">
                                    <input type="radio" class="data_type" name="data_type" value="unassigned" id="type3">
                                    <label for="type3">UA</label>
                                </span>
                                <!--<span class="tg-cancel tg-flagcolor4" style="display: none;">
                                    <input class="" type="radio" name="data_type" id="all_data_type">
                                    <label for="all_data_type">
                                        <img src="<?/*= base_url(); */?>assets/img/clearAll.png" class="img-responsive clearAll">
                                    </label>
                                </span>-->
                            </div>
                        </li>
    ...
    <div class="row report_listing" id="report-list-table">
        ...
        <?php echo form_open("admin/display_all", array('id' => 'assign_doc_form')); ?>
                    ...
                    foreach ($query as $row) 
          {
                        ...
                        $batchNo = '';
                        if (isset($row->record_batch_id) && !empty($row->record_batch_id)) {
                            $batchNo = $row->record_batch_id;
                        }
                        $lab_release_date = '';
                        ...
                        <?php if($sr_specialty !='')
            {
              ...
              <?php //echo $row->spec_grp_name; ?></td>
                            ...
                            <td>
                                <a class="hospital_initials" title="<?= $row->description; ?>" href="#" >
                                    <?= $row->first_initial . $row->last_initial; ?>
                                </a>
                                ...
                                */?><!--
                                <a class="hospital_initials" title="<?php /*echo $this->ion_auth->group($row->hospital_group_id)->row()->description; */?>" title="<?php /*echo $this->ion_auth->group($row->hospital_group_id)->row()->description; */?>" href="#" >
                                    <?php /*//echo $f_initial.''.$l_initial; */?>
                                </a>-->
                            </td>
                            <td ><?php echo $courierNo; ?><br><?php echo $batchNo; ?></td>
                            <td><?php //echo($specialty) ?>General</td>
                            ...
                            <td class="hide_content">
                                <p style="display:none;"><?php echo $row->user_type; ?></p>
                            </td>
                        </tr>
                            <?php } }else{ ?>
                            <tr class="<?php //echo $row_code; ?>">
                                <td class="<?php // echo $row_code; ?>">
								<a class="hospital_initials" title="<?php echo $row->spec_grp_name; ?>" href="#" >
                                        <?php echo @substr($row->spec_grp_name,0,1); ?>
                                    </a>
                                ...
                                <td>
                                    ...
                                    ?><a class="hospital_initials" title="<?php echo $this->ion_auth->group($row->hospital_group_id)->row()->description; ?>" href="#" ><?php echo $f_initial.''.$l_initial; ?></a>
                                </td>
                                <td><?php echo $courierNo; ?><br><?php echo $batchNo; ?></td>
                                <td><?php echo ($row->speciality_group_id=='2'?'Autopsy':$specialty); ?></td>
                                <td><?php echo $row->pci_number; ?><br></td>
                                <td><?php echo $row->f_name; ?><br><?php //echo $row->sur_name; ?></td>
                                <td><?php echo $row->nhs_number; ?><br><?php echo $row->age; ?> Y</td>
                                <td><?php echo $row->lab_number; ?><br><?php echo $lab_release_date; ?></td>
                                <td class="text-center"><div class="<?php echo $urgency_class; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $urgency_title; ?>" style="font-size:18px;"></div></td>

			...
			<div class="card">
				<div class="card-body dash_tabs nopadding new_height">
					<ul class="nav nav-tabs nav-tabs-solid nav-tabs-rounded">
						...
						<li class="nav-item"><a class="nav-link" href="#work_list" data-toggle="tab">Work List</a></li>
						<li class="nav-item"><a class="nav-link active" href="#tats" data-toggle="tab">TAT's</a></li>
					...
					<div class="tab-content">
						...
						<div class="tab-pane" id="work_list">
						...
						<div class="tab-pane active" id="tats" style="padding: 15px;">

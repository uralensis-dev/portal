							  ...
							  // echo $p_result->nhs_number;						   
                                ...
                                <table class="custom-table info_nndn2" style="margin-bottom: 0; width:98%">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td  style="width:20%">
                                            <span style="font-weight: 500">Gender: <?php print $p_result[0]->gender; ?></span>
                                        </td>
                                        <td  style="width:20%"><span style="font-weight: 500">DOB: <?php print $request_query[0]->dob;?> / <?php print @date_diff(date_create($request_query[0]->dob), date_create('today'))->y;?> y</span></td>
                                       <td style="width:20%">
                                        ...
                                        <td>
                                            <span class="pull-right edit_icon make_editable p_id_icon" style="margin-right: 25px;">
                                                    ...
                                                    <div class="row" data-key="dermatological_surgeon">
                                                        ...
                                                        <div class="col-xs-9 ">
                                                            ...
                                                            <div class="table-view-content">
                                                                <?php echo $this->Doctor_model->display_hospitals_list([$hospital_data[0]->id])[0]->name; ?>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>

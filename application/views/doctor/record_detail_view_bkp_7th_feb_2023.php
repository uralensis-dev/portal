            ...
            <div class="card">
                ...
                <ul class="nav nav-tabs" id="specimen_tab" role="tablist">
                    <?php foreach($specimen_query as $ind => $specimen_q): ?>
                        <li class="nav-item">
                            <a class="nav-link <?php if ($ind == 0) echo 'active';?>" id="specimen-tab-<?php echo $ind; ?>" data-toggle="tab" href="#specimen-<?php echo $ind; ?>" role="tab" aria-controls="Specimen <?php echo $ind+1; ?>" aria-selected="<?php if($ind == 0) echo 'true'; ?>">Specimen <?php echo $ind+1;?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>

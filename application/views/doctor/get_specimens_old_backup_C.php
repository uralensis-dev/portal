...
function get_specimens(
        ...
        $specimen_labeled_by,
        $specimen_qcd_by,
        $slide_data, $specimen_blocks, $testListArr) {
    $button_disable = '';
                            ...
                            <div class="form-group">
                                <select multiple name="test_ids[]" id="testName" placeholder="Test" class="test-list form-control select2">
                                    <?php foreach ($testListArr as $testRow) {
                                        echo '<option class="" value="'.$testRow['id'].'" title="'.$testRow['name'].'">'.$testRow['test_id'].'</option>';
                                    } ?>
                                </select>
...
<div class="col-md-12 nopadding form-group">
                                                            ...
                                                            foreach ($specimen_blocks as $sp_block) {
                                                                if ($sp_block->specimen_id == $row->specimen_id) {
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td><a href="<?php echo site_url() . '/doctor/delete_test/' . $sp_block->id; ?>" title="Remove this test."><strong><i class="fa fa-trash-o m-r-5"></i></strong></a></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                            }
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              ...
                              <input type="hidden" name="lab_id" id="lab_id" value="<?=$labId?>">      
              <button style="margin:10px;" class="btn btn-primary btn-rounded create_new_next_button pull-right"
                                    ...
                                    &nbsp;&nbsp;&nbsp; 
                                        <button <?php echo $button_disable; ?>
                                            ...
                                            style="margin:10px;" name="submit">Save Speciman <?php echo $inner_tab_count; ?>
                                        </button>

                ...
                <div class="col-lg-12 form-group">
                    <div class="row">
                        <div class="col-lg-2 form-group nopadding">
                            <label for="" style="margin-top: 10px;">First Name:</label>
                        </div>
                        <div class="col-lg-4 form-group">
                            <input type="text" name="animal_name" id="animal_name" value="<?php echo $recordDetails[0]["f_name"]; ?>" readonly="readonly" class="form-control" placeholder="Lab No.">
                        </div>

                        <div class="col-lg-2 form-group nopadding">
                            <label for="" style="margin-top: 10px;">NHS No:</label>
                        </div>
                        <div class="col-lg-4 form-group">
                            <input type="text" name="animal_id" id="animal_id" value="<?php echo $recordDetails[0]["nhs_number"]; ?>" readonly="readonly" class="form-control" placeholder="Lab No.">
                        </div>
                        ...
                        <div class="col-lg-4 form-group">
                            <select class="form-control select2" name="block_no" id="blockSelections">
                ...
                <div class="card-body">
                    <div class="table-responsive form-group">
                        <table class="table table-stripped custom-table custom-table-search" style="width: 100%;">
                            ...
                            <th class="text-right totalCost">0</th>
                            </tfoot>
                        </table>
                    </div>
                    <div class="row">

...
//        $_PDF_html .= '<table border="1" cellpadding="2" cellspacing="1" align="center">';
        $_PDF_html .= '<table border="0" cellpadding="2" cellspacing="1" align="left">';
//        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2"> Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2">Clinical Details  - Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $data_arr = '';
...
//                            }
                //$_PDF_html .= "<tr> <td><b> $key </b></td> <td> $val </td> </tr>";
                $_PDF_html .= $key != '' ? "<tr> <td><b> $key </b></td> <td> $val </td> </tr>" : '';
            }
        }
...
//                    $_PDF_html .= $_PDF_head . '<table border="1" cellpadding="2" cellspacing="1" align="center">';
        $_PDF_html .= '<table border="0" cellpadding="2" cellspacing="1" align="left">';
//        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2"> Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2">Macroscopic Description  - Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $data_arr = '';
        foreach ($data_set as $key => $val) {
...
//                    $_PDF_html .= $_PDF_head . '<table border="1" cellpadding="2" cellspacing="1" align="center">';
        $_PDF_html .= '<table border="0" cellpadding="2" cellspacing="1" align="left">';
//        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2"> Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2">Microscopic Description  - Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $data_arr = '';
        foreach ($data_set as $key => $val) {
...
//                    $_PDF_html .= $_PDF_head . '<table border="1" cellpadding="2" cellspacing="1" align="center">';
        $_PDF_html .= '<table border="0" cellpadding="2" cellspacing="1" align="left">';
//        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2"> Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $_PDF_html .= '<tr rowspan="2" style="color:black;font-size:18px;font-weight:bold"><td colspan="2">Comments  - Specimen ' . $get_bcc_record[$clinical_arr]['patient_specimen'] . '</td></tr>';
        $data_arr = '';
        foreach ($data_set as $key => $val) {
...
//                        }
            ...
            $data_arr = array('ptnm', 'ptnm_N', 'ptnm_M', 'bcc_comments');

<style type="text/css">
    ...
    #doctor_record_review_cases_wrapper .row:nth-child(2){
        margin:0;
    }
    #doctor_record_review_cases_wrapper .row:nth-child(2) .col-sm-12{
        padding-left: 0;
        padding-right: 0;
    }
    .tg-searchrecordhold .tg-breadcrumbvtwo li a{
...
<div class="container-fluid">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        ...
        <div class="col-xs-9 col-sm-9 col-md-9 col-lg-9 tg-breadcrumbarea tg-searchrecordhold" style="margin-top:-40px;">

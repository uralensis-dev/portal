...
class MYPDF extends TCPDF {
    ...
    public function Header() {
       ...
       // echo "Here we are!!!!<pre>";
        //print_r($hospitalInfo);
        //die;

		$hospitalI=$hospitalInfo['name']."<br>".$hospitalInfo['hosp_address']."<br>".$hospitalInfo['hosp_state']."<br>".$hospitalInfo['hosp_post_code'];
		...
		$logoVal = "https://portal.pathhub.live/assets/img/UralensisLogo.png";
            ...
            <tr>
                <td >								
                    <table>
                        ...
                        <tr rowspan="3"><td>$hospitalI</td></tr>
                    </table>
                </td>
				<td >								
                    <table>
						<tr ><td style="font-size:14px;" align="left">&nbsp;</td></tr>
                        <tr><td style="font-size:19px; color:BLACK" align="">Histopathology Report</td></tr>
						<tr ><td style="font-size:14px; color:BLACK" align="left">&nbsp;</td></tr>
                        <tr ><td style="font-size:14px; color:BLACK" align="left">SERVICE PROVIDER</td></tr>
						<tr ><td style="font-size:14px; color:BLACK" align="left">Uralensis Innov8</td></tr>						 
						<tr><td style="font-size:14px;" align="left">www.uralensis.com <br>
iskander.chaudhry@nhs.net<br>
Office: 01619808882<br></td></tr>
                    </table>
                </td>							
                <td>
                    <table>							
                        <tr>
                            <td>
                                <table>							
                                    ...
                                    $age
                                    $gender														
                                    <tr><td>Received By Lab:</td><td>$date_rec_bylab</td></tr>                                   
...
EOD;
    ...
    public function Footer() 
	{
		...
		$footerText = "Reported by Dr Iskander Chaudhry. Email: iskander.chaudhry@nhs.net. Mobile: 07593043609";
       /* $this->SetY(-30);

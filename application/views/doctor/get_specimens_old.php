...
.downloadBtn{
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div id=''>
                            ...
                            <input type="hidden" id="tetsIds" value=""/>
                            <input type="hidden" id="specimCount" value=""/>
                            <input type="hidden" id="specimBlockId" value=""/>
                            <input type="hidden" id="spePathologist" value=""/>
                            <a href="javascript:barcode_p(this,1);" data-value="" id="btn_barcode" data-type="1"  class="btn btn-primary">Generate Barcode</a>
                            <a href="javascript:barcode_p(this,3);" data-value="" id="btn_sp_pot" data-type="2" class="btn btn-success">Specimen Pot</a>
                            <a href="javascript:barcode_p(this,2);" data-value="" id="btn_sp_request" data-type="2" class="btn btn-info">Request</a>
                            <a href="javascript:request_download_barcode(4);" id="" class="downloadBtn btn btn-info">Download Barcode</a>
                            <a href="javascript:request_download_barcode(5);" id="" class="downloadBtn btn btn-info">Download Specimen Barcode</a>
                            <a href="javascript:request_download_barcode(6);" id="" class="downloadBtn btn btn-info">Download Request Barcode</a>
                            <a href="javascript:request_download_barcode(7);" id="" class="downloadBtn btn btn-info">Download Cassette</a>
                            </center>
                            </div>
                        </div>
                    </div>
    ...
    <div class="tg-inputshold specimen_content"> 
        ...
        <div class="col-md-12 nopadding">
            ...
            Documents <a href="javascript:void(0);" class="checv_up_down"><i class="fa fa-chevron-up"></i></a>
            </div>
                            ...
                            <div class="related-doc-collapse-section">
                                <div class="">
                                    <table class="table custom-table table-striped datatables dataTable no-footer">
                                        ...
                                        <?php
                                        if (isset($specimen_query[0]->files) && is_array($specimen_query[0]->files)) {
                                            // $doctor_id = $this->ion_auth->user()->row()->id;
                                            // $record_id = $this->uri->segment(3);
                                            foreach ($specimen_query[0]->files as $file) {
    ...
    foreach ($specimen_query[0]->patientInfo as $row2) 
    {
        $row2->city;
        $row2->hospital_id;
        $row2->address_1;
    ...
    ?>
    <div class="tg-inputshold specimen_content <?php echo ($hospital_infodata[0]->billing_type == 'by_specimen') ? "hide":"";?>"> 
    <div class="col-md-12 nopadding form-group">
            ...
            <div class="card hidden show">
                <div class="card-body">
                    <fieldset class="tg-tabfieldsettwo">
                        <div class="col-md-11 hide">
                            <div class="radio">
                                <label for="by_request"><input type="radio" name="billing_type" class="billing_type dusrd4" value="by_request" id="by_request" checked> By Request</label>
                                <!-- &nbsp;&nbsp; -->
                                <!-- <label for="by_specimen"><input type="radio" name="billing_type" class="billing_type dusrd4" value="by_specimen" id="by_specimen" <?= ($specimen_query[0]->billing_type == 'by_specimen') ? 'checked' : ''; ?>> By Specimen</label> -->
                                &nbsp;&nbsp;
                                <label for="not_billed"><input type="radio" name="billing_type" class="billing_type dusrd4" value="not_billed" id="not_billed"> Not Billed (PCI)</label>
                            </div>
                        </div>
                        <!--<div class="col-md-1">
                        ...
                        <?php $k=0; 
                        // echo "<pre>";
                        // print_r($specimen_query);die;
                        foreach ($specimen_query as $keyr => $row1) {
                            $k++;
                            if($keyr == 0){
                            ?>
                                    <div class="row">
                                        ...
                                        <div class="col-md-10">
                                            <select multiple name="bill_code[<?= $row1->specimen_id; ?>][]" class="form-control dusrd4 select2 globalBillingCode" data-live-search="true">
                                                <option value="">Select Bill Code</option>
                                                <?php
                                                    $addedIds = array_column($row1->request, 'bill_code');
                                                    foreach ($row1->bill_code_arr as $bData){
                                                ?>
                                                    <option value="<?= $bData['id']; ?>" <?= (in_array($bData['id'], $addedIds)) ? 'selected' : ''; ?>><?= $bData['bill_code']."-". $bData['bill_description']; ?></option>
                                                <?php } ?>
                                            </select>
                                        </div>
                                        <div class="clearfix"></div>

                                    <?php if(count($row1->request) > 0){ ?>
                                        <br>
                                    ...
                                    <hr/>-->
                            <?php foreach($row1->request as $reqRow){ $row2 = (object) $reqRow; if(!empty($row2->bill_code_text)) { ?>
                                <div class="row">
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2 form-group">
    ...
    <div class="tg-inputshold specimen_content">
        ...
        <div class="modal fade" id="add_block_modal" tabindex="-1" role="dialog" aria-hidden="true"
            ...
            <div class="tg-modaldialog modal-dialog" role="document" style="margin-top:10%; width:400px">
                ...
                <div class="tg-modalbody modal-body">
                    ...
                    <input type="hidden" name="brequestid" id="brequestid" value="<?php echo $request_query[0]->uralensis_request_id;; ?>">
                    <input type="hidden" name="blabid" id="blabid" value="<?php echo $request_query[0]->lab_id; ?>">
                    ...
                    <div class="row blocks_wrapper" id="blocks_check">
                        ...
                        <div class="col-md-5 padding-bottom">
                            <div class="form-group form-focus">
                                <input type="text" class="form-control" name="count_blocks" id="count_blocks" value="1" onkeypress="return isNumber(event)">
        ...
        <ul class="tg-themenavtabs nav navbar-nav" id="specimentHeader">
            <?php
            $active = 'active';
            $count = 1;
            foreach ($specimen_query as $row) {
                ...
                <li 
                    ...
                    <a 
                        ...
                        class="ds_click specimentWrapper" 
                        data-ds-controls="<?php echo $count; ?>"  
                        href="#tabs_<?php echo $count; ?>">
                        Specimen
                        <?php echo $count; ?></a>
...
<div class="col-md-12 nopadding form-group blockWrapper">
                            <div class="sec_title form-group">
                            ...
                            <div class="card hidden show">
                                <div class="card-body">
                                    <fieldset class="tg-tabfieldsettwo">
                                                    <button type="button" class="addBlockButton btn btn-info block_model_btn_<?php echo $inner_tab_count; ?>"
                                                            data-specimenid="<?php echo $row->specimen_id; ?>"
                                                            ...
                                                            <button class="btn btn-info" type="button" style="float: right;margin-right: 20px;margin-top: 10px;" data-toggle="modal" data-target="#rec_block_history_modal"><i class="fa fa-eye"></i></button>
                                                    <table class="table custom-table table-striped datatables dataTable no-footer" id="specimen_<?php echo $row->specimen_id; ?>">
                                                        ...
                                                        <?php 
                                                            $path_id=get_table_data("request_assignee","request_id=".$request_query[0]->uralensis_request_id);
                                                            ...
                                                            $pathlogositName = $Usersgetdatils[0]->first_name . '&nbsp;' . $Usersgetdatils[0]->last_name;
                                                            
                                                            $patientName = substr($request_query[0]->f_name, 0, 1).".".preg_replace('/[^A-Za-z0-9 ]/', '', $request_query[0]->sur_name);
                                                            ...
                                                            $parameters['channel_no'] = $hospital_infodata[0]->channel_no;
                                                            $parameters['ref_lab_number'] = $hospital_infodata[0]->ref_lab_number;
                                                            //print_r($parameters);
                                                        ?>
                                                            <?php
                                                            $cnt = 0;
                                                                ...
                                                                if ($sp_block->specimen_id == $row->specimen_id) {
                                                                    ...
                                                                    <tr>
                                                                       ...
                                                                       <!-- <td><?php $test = "H&E"; if($sp_block->name!='') { echo $test =$sp_block->name; } else { print "H&E";} ?></td> -->
                                                                        <td>
                                                                        <select multiple name="test_ids[]" data-id="<?= $sp_block->id; ?>" data-sid="<?php echo $sp_block->specimen_id; ?>" data-sno="<?php echo $sp_block->specimen_no; ?>" data-bno="<?php echo $sp_block->block_no; ?>" id="blocks_<?php echo $sp_block->id; ?>" placeholder="Test" class="test_wrap test-list form-control select2 SpecimenData<?php echo $sp_block->id; ?>">
                                                                                <?php 
                                                                                    $temp = 0;
...
<!--                                                                        <td>--><?php //echo $sp_block->description; ?><!--</td>-->
                                                                        ...
                                                                        $parameters['pathlogositName'] = $pathlogositName;
                                                                        $parameters['patientName'] = $patientName;
                                                                        $parameters['dropdownSelector'] = 'blocks_'.$sp_block->id;
                                                                        $parameters['specimentCounts'] = $count_speciment_block_tem;
                                                                        $parameters['spBlockId'] = $sp_block->id;
                                                                        ...
                                                                        ?>
                                                                        <?php $status_array = array('Embedding & Microtomy','Staining','Quality Assurance','Slide Scanner','Reporting','Admin Support', 'Further Work'); ?>
                                                                        ...
                                                                        <!-- <a href="<?php echo site_url() . '/doctor/delete_multiple_test/' . urlencode($sp_block->test_ids) .'/'. $record_id; ?>" title="Remove this test."><strong><i class="fa-2x fa fa-trash-o m-r-5"></i></strong></a></td> -->
                                                                            <?php if($count_speciment_block_tem == $cnt && !in_array($request_query[0]->request_code_status, $status_array)) { ?>
                                                                            <a href="javascript:void(0);" data-sno="<?php echo $sp_block->specimen_no; ?>" data-href="<?php echo site_url() . '/doctor/delete_multiple_test/' . urlencode($sp_block->test_ids) .'/'. $record_id; ?>" title="Remove this test." class="delete_test"><strong><i class="fa-2x fa fa-trash-o m-r-5"></i></strong></a></td>
                                                                        <?php } ?>
                                                                    </tr>
                                                                    <?php
                                                                }
                        ...
                        <div class="col-md-12 nopadding form-group <?php echo ($hospital_infodata[0]->billing_type == 'by_specimen') ? "":"hide";?>">
                            <div class="sec_title form-group">
                                Billing
                                <a href="javascript:;" class="checv_up_down"><i class="fa fa-chevron-up"></i></a>
                            </div>
                            <div class="card hidden show">
                                <div class="card-body">
                                    <fieldset class="tg-tabfieldsettwo">
                                        <div class="col-md-11 hide">
                                            <div class="radio">
                                                <label for="by_request"><input type="radio" name="billing_type" class="billing_type dusrd" value="by_request" id="by_request"> By Request</label>
                                                &nbsp;&nbsp;
                                                <label for="by_specimen"><input type="radio" name="billing_type" class="billing_type dusrd" value="by_specimen" id="by_specimen" checked> By Specimen</label>
                                                &nbsp;&nbsp;
                                                <label for="not_billed"><input type="radio" name="billing_type" class="billing_type dusrd" value="not_billed" id="not_billed"> Not Billed (PCI)</label>
                                            </div>
                                        </div>
                                        <!--<div class="col-md-1">
                                            <button type="button" class="btn add_new_bill btn-info billing_model_btn_<?/*= $inner_tab_count; */?>" data-specimenid="<?/*= $row->specimen_id; */?>" data-labno="<?/*= $row->lab_number; */?>" data-innertab="<?/*= $inner_tab_count; */?>" style="float: right;margin-right: 20px;"><i class="fa fa-plus"></i></button>
                                        ...
                                        <?php $k=0; foreach ($specimen_query as $key1=>$row1) {
                                            ...
                                            ?>
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            <select multiple name="bill_code[<?= $row1->specimen_id; ?>][]" class="form-control dusrd select2 specificBillingCode" data-live-search="true">
                                                                <option value="">Select Bill Code</option>
                                                                <?php
                        ...
                        <?php if (get_ds_status($CI->uri->segment(3)) == 0) { ?>
                            <div class="col-md-12 nopadding" style="pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                <div class="sec_title form-group">
                                        ...
                                        <fieldset class="tg-tabfieldsetfour">
                                            <div class="form-group">
                                                <div class="tg-formhead">
                                                    <h3>Diagnosis:</h3>
                                                    <ul class="tg-themeinputbtn" style="pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                                        <li>
                                                            <?php
                                                            $checked = '';
                                                            if ($row->specimen_benign == 'benign') {
                                            ...
                                            <div class="form-group tg-formgroupcheck specimen-diagnose-field" style="pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                            ...
                                            <div class="form-group halfformgroup specimen_snomed_options" style="pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                            ...
                                            <div class="clearfix"></div>
                                            <div class="form-group tg-formgroupcheck halfform-group" style="pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                            ...
                                            <div class="form-group tg-formgroupcheck halfform-group" style="display: flex; flex-direction: column;">
                                                
                                                <div class="comments_detail_html" style="max-height: 156px;overflow: scroll;pointer-events: <?php echo ($request_query[0]->group_type == 'D') ? "" : "none"; ?>;">
                                                        ...
                                                        <div class="d-flex flex-column comment-section">
                                                            <div class="bg-light p-2">
                                                                ...
                                                                <div class="mt-2 text-right" style="margin-top: 15px;">
                                                                    <button class="btn btn-primary btn-sm shadow-none post_comment_btn" type="button">Post comment
                                                                    </button>
                ...
                error: function (err) {
                    ...
                    <script>
                        ...
                        jQuery(document).ready(function () {
                            $(document).on('change', '.globalBillingCode',function(){
                                $('.specificBillingCode').val($(this).val());
                            ...
                            $(document).on('change','.test_wrap',function(e){
                    ...
                    <script>
                        $(document).ready(function () {
                            <?php if(isset($_GET['blocks']) && $_GET['blocks'] == 1){ ?>
                                    $(window).scrollTop($('.blockWrapper').offset().top-250);
                            <?php } ?>
                            <?php if(isset($_GET['spe']) && $_GET['spe'] == 1){ ?>
                                    $(window).scrollTop($('.specimentWrapper').offset().top-250);
                            <?php } ?>
                                    ...
                                    $.ajax({
                                        ...
                                        success: function (response) {
                                            ...
                                            if (response.type === 'success') {
                                                ...
                                                var origin = window.location.origin;
                                                if (origin == 'http://localhost') {
                                                    url = origin + '/pci/doctor/doctor_record_detail_old/' +$('#record_id').val() + '?stab='+selected_specimen+'&blocks=1';
                                                } else {
                                                    url = origin + '/doctor/doctor_record_detail_old/' +$('#record_id').val() + '?stab='+selected_specimen+'&blocks=1';
                                                }
                                                window.location.href = url;
                                                //location.reload();
                                            } else {
        ...
        $(document).ready(function () {
            ...
            $(document).on("click",".post_comment_btn",function () {
                ...
                $.ajax({
                    ...
                    data:  {[csrf_name]: csrf_hash,task_comment_id: dataId,data_section: dataSection,flag_comment: flag_comment, record_id: $('#record_id').val()},
                    dataType: "json",
                    success: function (response) {
                        if (response.type === 'success') {

        ...
        <div class="container-fluid tab-full">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="form-group col-md-2 text-right nopadding-right hide" style="float: right;">
 ...
 <?php
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="dermatological_surgeon">Clinician &nbsp;
                                                    <a href="javascript:void(0);" class="add_new_clinician hide" title="Add New Clinician" data-toggle="modal" data-target="#add_clinician_modal">
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="pathologist">Pathologist - Pcr6990 &nbsp;
                                                    <a href="javascript:void(0);" class="add_new_pathologist hide" title="Add New Pathologist" data-toggle="modal" data-target="#add_pathologist_modal">
                                                        <i class="fa fa-plus"></i>
                                                    </a>
                                                </label>
                                    ...
                                    <table class="table custom-table table-striped datatables dataTable no-footer">
                                        ...
                                        if (isset($files) && is_array($files)) {
                                            ...
                                            foreach ($files as $file) {
                                                ...
                                                $path1 = base_url() . 'lab_uploads/' . $file->file_name;

            ...
            <div class="form-group form-focus select-focus">
                <div class="">
                    ...
                    <select class="select2 " name="doctor[]" id="doctor">
                        <option value="0">Choose Pathologist</option>
                        <?php
                    ...
                    <label class="focus-label">Choose Pathologist</label>
                </div>
            </div>
        </div>
        <div class="col-sm-1 col-md-1">
            <div class="form-group">
                <button type="button" id="assign_btn" class="btn btn-sm btn-primary" onClick="AssignInDoctor()">Assign</button>
            </div>
                    ...
                    <div class="tg-filterhold">
                        <ul class="tg-filters record-list-filters">
                            ...
                            <li class="tg-statusbar tg-flagcolor custome-flagcolors pull-right nobefore search_li" style="padding: 0">
                                <select class="select2" multiple name="doctor222[]" id="doctor222">
                                    ...
                                    <tr>
                                        <td class="col-md-12">
                                            <select class="form-control filter_by_hospital" name="filter_by_hospital">
                                                ...
                                                echo '
                                                <option value="' . $list_hospitals->id . '">' . $list_hospitals->description . '</option>';
                                                }
                                                }
                                                ?>
                                            </select>
            ...
            <div class="col-md-12">
                ...
                <table id="doctor_record_list_table" class="table table-striped custom-table" cellspacing="0" width="100%" style="margin-top:40px">
                    <thead>
                        <tr>
                            <th>Batch No</th>
                            <th>PCI No. / Track No.</th>
                            <th>Client<br>Clinic</th>
                            <th>Courier  No.</th>
                            <th>Speciality</th>
                            <th>Accession / Lab No.</th>
                            <th>Patient Name</th>
                            <th>NHS No.<br>DOB</th>
                            <th>Pathologist</th>
                            <th>
                    ...
                    if($specialty_id== $sr_specialty){?>
                        <tr>
                            <td><?php echo $batchNo; ?><?php //echo $row->spec_grp_name; ?></td>
                            ...
                            <td style="width:146px !important" width="146"><?php echo $courierNo; ?></td>
                        ...
                        <tr class="<?php //echo $row_code; ?>">
                            <td class="<?php // echo $row_code; ?>"><?php if($row->assign_status!=1) {?><input type="checkbox" name="<?php echo $row->request_id?>" value="<?php echo $row->request_id?>" /><?php } ?><?php echo $batchNo; ?><?php //echo $row->spec_grp_name; ?></td>
                            ...
                            <td style="width:93px !important" width="93"><?php echo $row->f_name; ?><br><?php echo $row->sur_name; ?></td>
                            <td><?php echo $row->nhs_number; ?><br><?php echo $dob; ?></td>
                            <td>Mark Edwards<br><?php echo $lab_release_date; ?></td>
                            <td class="text-center"><div class="<?php echo $urgency_class; ?>" data-toggle="tooltip" data-placement="top" title="<?php echo $urgency_title; ?>" style="font-size:18px;"></div></td>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <div class="flag_msg" style="border:solid 1px #ccc; border-radius:4px; padding:3px;">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>
                                                <div class="flag_msg" style="border: solid 1px #ccc; border-radius: 4px; padding: 3px; margin-top: 10px">the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s</div>

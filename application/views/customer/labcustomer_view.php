        ...
        <div class="">
            <table class="table table-striped datatable custom-table">
                ...
                <tbody> 
                  ...
                  foreach($hospital_data as $resValue) 
				  {
                      $cnt ++;
                  ?>                   
                  <tr>
                        ...
                        <td><?=$resValue->description?></td>
                        <td><?=$resValue->hosp_email?></td>
                        <td><?=$resValue->hosp_phone?></td>
                        <td>30/12/2021</td>
                        <td class="center"><a href="<?php echo base_url(); ?>/customer/InvoiceDetails/">0</a></td>                        
                        <td class="text-right">
                            <div class="dropdown dropdown-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
									<a class="dropdown-item" href="<?php echo base_url(); ?>/customer/InvoiceDetails/<?=$resValue->group_id?>"><i class="fa fa-eye m-r-5"></i>View</a>

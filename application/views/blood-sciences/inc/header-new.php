...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/css/pprofile_custom.css')?>">
        <?php
        if (!empty($styles)) {
        ...
        ?>
        <link href="<?php echo base_url('/assets/css/blood-sciences.css'); ?>" rel="stylesheet" />

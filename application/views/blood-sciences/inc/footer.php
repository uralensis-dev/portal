...
$(document).ready(function() {
    ...
    $(document).on('click', '.login-as-admin', function(e) {
        ...
        $.ajax({
            ...
            global: false,
            beforeSend: function() {
                $.sticky('Please wait we are redirecting......', { classList: 'success', speed: 'slow' });
...
$(document).ready(function() {
    ...
    $(document).on('click', '.edt-tckt', function(elem) {
        ...
        $.ajax({
            url: '<?php echo base_url('/index.php/tickets/editTicket'); ?>',
            type: 'POST',
            global: false,
            data: { 'info': info, '<?php echo $this->security->get_csrf_token_name(); ?>': cct },
            success: function(data) {
    ...
    $(document).on('click', '.del-tckt', function(elem) {
        var info = $(this).data('info');
        $(document).find('.tckt-del-btn').attr('href', '<?php echo site_url('tickets/delete/'); ?>' + info);
    });
    ...
    $(document).on('click', '#search_user', function(elem) {
        var cct = $.cookie("<?php echo $this->config->item("csrf_cookie_name"); ?>");
        var s_str = $('#s_str').val();
        var ticket_id = $('#ticket_id').val();
        $('#user-list-cont').html('<i class="fa fa-circle-o-notch fa-spin" style="font-size:20px;"></i>');
        $.ajax({
            url: '<?php echo base_url('/index.php/tickets/userList'); ?>',
            type: 'POST',
            global: false,
            data: { 'ticket_id': ticket_id, 's_str': s_str, '<?php echo $this->security->get_csrf_token_name(); ?>': cct },
            success: function(data) {
                $('#user-list-cont').html(data);
            }
        });
    });
    /**********************
...
<script type="text/javascript">
    ...
    if (document.getElementById('abc-charts') != null) {
        Morris.Bar({
            element: 'abc-charts',
            data: [
                { y: '2006', a: 100, b: 90 },
...
// Create axes
          ...
          valueAxis2.title.text = "# of Cases Percentage";
      ...
      //        series.sequencedInterpolation = true;
         ...
         createSeries("tat_less_ten", "Cases < 10 TAT",am4core.color('#019FEB'));
          ...
          series4.name = "Tat < 10 Percentage";
...
// create chart
        var chart = am4core.create("last_month_TAT", am4charts.GaugeChart);
        ...
        gradient.stops.push({color:am4core.color("#67B7DC")});
        gradient.stops.push({color:am4core.color("#6771DC")});
        gradient.stops.push({color:am4core.color("#A367DC")});
        ...
        hand.zIndex = 100;
        hand.showValue(22, 1000, am4core.ease.cubicOut);
...
// labelList.template.fontWeight = "bold";
        ...
        var TitleLabel = labelList.create();
...
// TitleLabel.background.stroke = am4core.color(budget_ytd_color);
        ...
        var ValueLabel = labelList.create();
...
// create chart
            var chart = am4core.create("last_3months_TAT", am4charts.GaugeChart);
            chart.innerRadius = -15;
...
// Chart Title
            ...
            hand.radius = am4core.percent(90);
            hand.zIndex = 100;
            hand.showValue(45, 1000, am4core.ease.cubicOut);
...
// create chart
            var chart = am4core.create("last_6months_TAT", am4charts.GaugeChart);
            chart.innerRadius = -15;
...
// Chart Title
            ...
            hand.radius = am4core.percent(90);
            hand.zIndex = 100;
            hand.showValue(81, 1000, am4core.ease.cubicOut);

...
window.onload = function () {
    ...
    $(".sc_open").click(function(){
        $(".sc_opener").toggleClass('hidden');
    });
    $(".sn_open").click(function(){
        $(".sn_opener").toggleClass('hidden');
    });
    $(".icd_open").click(function(){
        $(".icd_opener").toggleClass('hidden');
    });
    $(".cpt_open").click(function(){
        $(".cpt_opener").toggleClass('hidden');
    });

...
<div class="container-fluid">
    <div class="record_publish_listing">
        <div class="col-xs-12 col-sm-8 form-group" style="padding-left: 0;">
        ...
        <div class="col-sm-4 form-group" style="padding-right: 0;">
            ...
            <a href="javascript:void(0);" id="show_upload_div" class="btn add-btn mr-2"><i class="fa fa-upload"></i> Import CSV</a>
            ...
            <a href="#" class="btn add-btn mr-2" data-toggle="modal" data-target="#add-lab-test-category-modal"><i class="glyphicon glyphicon-plus-sign"></i> Add test categories</a>
        </div>
...
<!--                                <i class="fa fa-download"></i>-->
            ...
            <div class="col-md-offset-8 col-sm-4 form-group">
                <button class="btn-danger selected_delete"><i class="glyphicon glyphicon-trash"></i> Delete </button>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="row">
                    <div class="col-md-12" id="department_id_container">
                        <div class="form-group">
                            ...
                            <select name="department_id" id="department_id" class="select2 form-control" data-rule-required='true'>
                    ...
                    <div class="col-md-12" id="specialty_id_container">
                        <div class="form-group">
                            ...
                            <select name="specialty_id" id="specialty_id" class="select2 form-control" data-rule-required='true'>

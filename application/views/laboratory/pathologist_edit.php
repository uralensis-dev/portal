...
<div class="row">
    <div class="col-sm-12">
        <?php echo form_open_multipart("laboratory/edit_pathologist/$id", array('class' => 'tg-formtheme tg-editform')); ?>
        <div class="row">
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select class="select2" name="pathologist_id" id="pathologist_id">
                                <?php foreach ($pathologistArr as $pathologist){ ?>
                                    <option value="<?= $pathologist->id; ?>" <?= ($pathologist->id == $resultArr->pathologist_id) ? 'selected' : ''; ?> ><?= $pathologist->first_name .' '. $pathologist->last_name; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="price" class="form-control numberonly" placeholder="Enter Price Here" value="<?= $resultArr->price; ?>" >
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-sm-6 col-md-6">
                <div class="form-group">
                    ...
                    <div class="field_wrapper">
                        <textarea type="text" rows="8" name="description" class="form-control" placeholder="Enter Description"><?= $resultArr->description; ?></textarea>
                    </div>
                </div>
            </div>
        </div>

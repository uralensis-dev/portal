                    ...
                    <div class="container-fluid">
                        ...
                        <div id="navbar" class="navbar-collapse collapse">
                            <ul class="nav navbar-nav pull-right">
                                <li class="<?php echo $this->uri->segment(1) == "pm" ? 'active' : ''; ?>">
                                    <?php echo anchor('pm', 'Private Messages'); ?>
                                </li>
                                <?php if (isset($_SESSION['admin_id'])) { ?>
                                <li>
                                    <?php echo anchor('laboratory/switchUserAccountToAdmin/' . intval($_SESSION['admin_id']), 'Logout to Admin'); ?>
                                </li>
                                <?php } else { ?>
                                <li>

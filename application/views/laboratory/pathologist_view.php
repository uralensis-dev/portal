...
<div id="grid_view" class="fade hidden show">
    ...
    <?php $cnt = 0; foreach($pathologistArr as $pRow) { $cnt ++; $resValue = (array) $pRow; ?>
        ...
        <div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
            <div class="profile-widget">
                ...
                <h4 class="user-name m-t-10 mb-0 text-ellipsis"><a href="<?= base_url('laboratory/edit_user/') . $resValue["user_id"]; ?>"><?= $resValue["enc_first_name"].' '.$resValue["enc_last_name"];?></a></h4>
                <div class="small text-muted"><?= $resValue["description"];?></div>
                <br>
                <a class="edit-btn" href="<?= base_url('laboratory/edit_user/') . $resValue["user_id"]; ?>" ><i class="fa fa-pencil m-r-5"></i> Edit</a>
                <a class="del-btn" href="javascript:delete_pathologist('<?= base_url('laboratory/delete_user/') . $resValue["user_id"]; ?>')" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="table-responsive">
                <table class="table table-striped datatable custom-table">
                    ...
                    <tbody> 
                      <?php $cnt = 0; foreach($pathologistArr as $pRow) { $cnt ++; $pathologist = (array) $pRow; ?>
                        <tr>
                            <td><?= $cnt; ?></td>
                            <td><?= $pathologist["enc_first_name"] .' '. $pathologist["enc_last_name"];?> </td>
                            <td><?= $pathologist["enc_email"];?></td>
                            <td><?= $pathologist["enc_phone"];?></td>
                            <td><?= $pathologist["enc_company"];?></td>
                            <td><?= $pathologist["fee_per_case"];?></td>
                            <td><?= $pathologist["fee_per_specimen"];?></td>
                            <td class="text-center">
                                <div class="dropdown dropdown-action">
                                    <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="<?= base_url('laboratory/edit_user/') . $pathologist["user_id"];?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        <a class="dropdown-item" href="javascript:delete_pathologist('<?= base_url('laboratory/delete_user/') . $pathologist["user_id"]; ?>')"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                    </div>
                                </div>
                            </td>
                        </tr>                    

                ...
                <div class="profile-widget">
                    ...
                    <div class="dropdown profile-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right">
                            ...
                            <!-- Show delete option when ther is team member is empty -->
                            <?php
                            if ($resValue['employee_count'] == 0) :
                            ?>
                                <a class="dropdown-item" href="<?php echo base_url(); ?>auth/delete_group/<?php echo $resValue["group_id"]; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                <!-- <a class="dropdown-item delete-user" href="javascript:void(0);" data-toggle="modal" data-delete_url="<?php echo base_url(); ?>auth/delete_group/<?php echo $resValue["group_id"]; ?>" data-target="#delete_team_member"><i class="fa fa-trash-o m-r-5"></i> Delete</a> -->
                            <?php endif; ?>
                        </div>
                    </div>
                    <?php //} 
                    ...
                    <div class="small text-muted"><?php echo $resValue["lab_city"]; ?></div>
                    <div class="row">
                        <div class="col-md-3 main-outer">
                            <div class="profile-clinic"> <i class="la la-stethoscope"></i> <strong><?= $resValue['patient_count']; ?></strong></div>
                        </div>
                        <div class="col-md-3 main-outer">
                            <div class="profile-clinic"><img src="<?php echo base_url() ?>assets/icons/UnPublishBlack.png" class="mr-223" width="20px"><img src="<?php echo base_url() ?>assets/icons/white/unpublish.png" class="mr-1" width="20px"><strong><?= $resValue['request_count']; ?></strong>
                            </div>
                        </div>
                        <div class="col-md-3 main-outer">
                            <div class="profile-clinic"> <a href="javascript:br_template_modal('<?php echo $resValue["hospital_id"]; ?>');"><i class='fa fa-barcode mr-2'></i>0</a></div>
                        </div>
                        <div class="col-md-3 main-outer">
                            <div class="profile-clinic"> <a href="<?php echo base_url() . "laboratory/team_view/" . base64_encode($resValue["hospital_id"]); ?>"><i class='fa fa-user mr-2'></i><?= $resValue['employee_count']; ?></a></div>
                        </div>
                    </div>
                </div>
...
<div id="list_view" class="fade hidden">
    <div class="row">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a class="dropdown-item" href="<?php echo base_url(); ?>laboratory/edit_clinic/<?php echo base64_encode($resValue["hosp_id"]); ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                        <?php if ($resValue['employee_count'] == 0) : ?>
                                            <!-- <a class="dropdown-item" href="<?php echo base_url(); ?>auth/delete_group/<?php echo $resValue["group_id"]; ?>"  ><i class="fa fa-trash-o m-r-5"></i> Delete</a> -->
                                            <a class="dropdown-item delete-user" href="javascript:void(0);" data-toggle="modal" data-delete_url="<?php echo base_url(); ?>auth/delete_group/<?php echo $resValue["group_id"]; ?>" data-target="#delete_team_member"><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                        <?php endif; ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="card mb-4 ac-card">
                                    <div class="row mb-4">
                                        <div class="col-md-12">
                                            <button class="btn btn-primary" data-toggle="collapse" data-target="#active-directory-select-container">Active Directory
                                            </button>
                                        </div>
                                    </div>
        ...
        <!-- Modal popuop for delete record -->
        <div class="modal custom-modal fade" id="delete_team_member" role="dialog">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-body">
                        <?php echo form_open(site_url('/'), array('id' => 'delete_member')); ?>
                        ...
                        <div class="modal-btn delete-action">
                            ...
                            <div class="row">
                            <label>Please enter passcode to delete</label>
                                <div class="col-md-12 mb-3">
                                    <input type="text" name="passcode" class="passcode form-control" placeholder="Please enter passcode to delete">
                                </div>
                                <div class="col-6">
                                    <a href="javascript:void(0);" class="btn btn-primary delete_this_record continue-btn">Delete</a>
                                </div>
                                <div class="col-6">
        ...
        <script>
            $(document).ready(function() {
                $(".delete-user").click(function() {
                    ...
                    $('.delete_this_record').attr('customurl', url);
                    // $(".delete_this_record").attr("href",url);
                });
                ...
                //  Delete code here
                $(document).on('click', '.delete_this_record', function() {
                    var passcode = $(".passcode ").val();
                    // Get login token here
                    jQuery.ajax({
                        type: "GET",
                        url: site_url + "auth/get_login_token",
                        data: {
                            'crsr_token': jQuery.now()
                        },
                        dataType: "json",
                        success: function(data) {
                            if (passcode != data) alert('Wrong Passcode');
                            else {
                                var url = $('.delete_this_record').attr('customurl');
                                $('.delete_this_record').attr('href', url);

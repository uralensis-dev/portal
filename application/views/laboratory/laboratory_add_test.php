...
<!--                                <i class="fa fa-download"></i>-->
            ...
            <div class="row">
            <div class="col-sm-12 button-delete form-group new-btn" style="text-align:end; padding-right: 35px; padding-top: 10px;">
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <h3><strong>Added Category List</strong></h3>
                <div class="row">
                    <div class="col-md-12">
                        <table id="category_list" class="table table-striped custom-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="col-form-label">Category</label>
                            <select name="category" id="main_category_id" class="main_category_id select2 form-control" data-rule-required='true'>
                ...
                <br>
                <h3><strong>Added Sub Category List</strong></h3>
                <div class="row">
                    <div class="col-md-12">
                        <table id="sub_category_list" class="table table-striped custom-table" cellspacing="0" width="100%">
                            <thead>
                                <tr>
                                    <th width="10%">#</th>
                                    <th width="75%">Title</th>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group" style="margin-bottom: 10px;">
                                    ...
                                    <?php } else { ?>
                                        ...
                                        <input type="hidden" id="lab_id" name="lab_id" value="65">
                            ...
                            <div class="col-md-12" id="specialty_id_container" style="display: block            ;">
                                <div class="form-group">
                                    <label class="col-form-label">Specialty</label>
                                    <select name="specialty_id" id="specialty_id" class="specialty_id select2" data-rule-required='true'>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-12" id="edit_specialty_id_container" style="display: none;">
                                <div class="form-group">
                                    <label class="col-form-label">Specialty</label>
                                    <select name="specialty_id" id="edit_specialty_id" class="select2" data-rule-required='true'>
...
<div class="modal custom-modal fade" id="delete_sub_cat_modal" role="dialog">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-body">
                <div class="form-header">
                ...
                <div class="modal-btn delete-action">
                    <div class="row">
                        <div class="col-6">
                            <a href="javascript:void(0);" class="btn btn-primary continue-btn sub-cat-delete-btn">Delete</a>
                        </div>
                        <div class="col-6">

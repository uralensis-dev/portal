                                            ...
                                            if (!empty($hos_users)) {
                                                foreach ($hos_users as $users) {
                                                    ...
                                                    <div class="input-holder">
                                                        <input class="tat hospital_user" data-hospitalname="<?php echo !empty($hospital_name) ? html_purify($hospital_name) : ''; ?>" type="radio" id="hospital_<?php echo intval($users->id); ?>" name="hospital_user" value="<?php echo intval($users->id); ?>">
                                                        <label for="hospital_<?php echo $users->id; ?>"><?php echo !empty($hospital_name) ?  html_purify($hospital_name) : ''; ?></label>
                                                    </div>
                                                    <?php
                                                }
                                            }
                                        ...
                                        <div class="input-scroll-holder ura-custom-scrollbar">
                                            ...
                                            if (!empty($lab_names)) {
                                                foreach ($lab_names as $labs) {
                                                    ?>
                                                    <div class="input-holder">
                                                        <input class="tat" data-labname="<?php echo html_purify($labs->lab_name); ?>" type="radio" id="lab_<?php echo intval($labs->lab_name_id); ?>" name="lab_name" value="<?php echo intval($labs->lab_name_id); ?>">
                                                        <label for="lab_<?php echo intval($labs->lab_name_id); ?>"><?php echo html_purify($labs->lab_name); ?></label>
                                                    </div>                                                   
                                                    <?php
                                                }
                                            }
                                        ...
                                        <div class="input-scroll-holder ura-custom-scrollbar">
                                            ...
                                            if (!empty($doctor_list)) {
                                                foreach ($doctor_list as $doctor) {
                                                    ?>
                                                    <div class="input-holder">
                                                        <input class="tat" type="radio" data-pathologist="<?php echo html_purify($doctor->first_name) . ' ' . html_purify($doctor->last_name); ?>" id="doctor_<?php echo intval($doctor->id); ?>" name="pathologist" value="<?php echo intval($doctor->id); ?>">
                                                        <label for="doctor_<?php echo $doctor->id; ?>"><?php echo html_purify($doctor->first_name) . ' ' . html_purify($doctor->last_name); ?></label>
                                                    </div>
                                                    <?php
                                                }
                                            }
                                    ...
                                    <div class="show_report_urgency">
                                        ...
                                        <div class="input-scroll-holder">
                                            ...
                                            foreach ($report_urgeny_data as $key => $urgency) {
                                                ?>
                                                <div class="input-holder">
                                                    <input class="tat" data-urgency="<?php echo html_purify($urgency); ?>" type="radio" id="report_<?php echo html_purify($key); ?>" name="report_urgency" value="<?php echo html_purify($key); ?>">
                                                    <label for="report_<?php echo $key; ?>"><?php echo html_purify($urgency); ?></label>
                                                </div>
                                                <?php
                                            }
                                            ?>
                                    ...
                                    <div class="show_specimen_type">
                                        ...
                                        <div class="input-scroll-holder">
                                            ...
                                            foreach ($specimen_type_data as $key => $specimen_type) {
                                                ?>
                                                <div class="input-holder">
                                                    <input class="tat" data-specimentype="<?php echo html_purify($specimen_type); ?>" type="radio" id="speci_type_<?php echo html_purify($key); ?>" name="specimen_type" value="<?php echo html_purify($key); ?>">
                                                    <label for="speci_type_<?php echo $key; ?>"><?php echo html_purify($specimen_type); ?></label>
                                                </div>
                                                <?php
                                            }
                                            ?>

...
<script src="<?php echo base_url('/assets/newtheme/plugins/morris/morris.min.js'); ?>"></script>
<script src="<?php echo base_url('/assets/newtheme/plugins/raphael/raphael.min.js'); ?>"></script>
<script src="<?php echo base_url('/assets/newtheme/js/chart-ncwtwmds.js'); ?>"></script>

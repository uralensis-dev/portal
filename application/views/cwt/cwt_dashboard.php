...
<style type="text/css">
    ...
    .dash-widget-info{margin-bottom: 15px;}
    .dash-widget-info h3{padding-right: 40px;}
    .dash-widget-info h3 small{display: block; font-size: 14px; font-weight: bold}
    .dash-widget-icon{
...
<div class="clearfix"></div>
    ...
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
        <h3 class="page-title">CWT Dashboard</h3>
        <div class="tg-breadcrumbarea tg-searchrecordhold">
            <div class="tg-breadcrumbarea tg-searchrecordhold">
                <ol class="tg-breadcrumb tg-breadcrumbvtwo">
                    <li class="active">CWT</li>
                    <li class="active">TWW Report</li>
                </ol>
            </div>
        </div>
    </div>
...
<div class="row top_dash">
        ...
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon">
                    <img src="<?php echo base_url()?>assets/icons/tww.png" class="image-responsive">
                </span>
                <div class="dash-widget-info">
                    <h3>112 
                        <small><span>TWW</span></small>
                    </h3>
                    <img src="<?php echo base_url()?>assets/icons/focus.png" class="tt_img">
                </div>
    ...
    <div class="col-md-3">
        <div class="card dash-widget">
            <div class="card-body">
                <span class="dash-widget-icon">
                    <img src="<?php echo base_url()?>assets/icons/31d.png" class="image-responsive">
                </span>
                <div class="dash-widget-info">
                    <h3>44 
                        <small><span>31d</span></small>
                    </h3>
                    <img src="<?php echo base_url()?>assets/icons/focus.png" class="tt_img">
                </div>
    ...
    <div class="col-md-3">
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h3>37 
                        <small><span>Subsequent Treatment 31d</span></small>
                    </h3>
                    <img src="<?php echo base_url()?>assets/icons/focus.png" class="tt_img">
                </div>
    ...
    <div class="col-md-3">
        <div class="card dash-widget">
            <div class="card-body">
                ...
                <div class="dash-widget-info">
                    <h3>37 
                        <small><span>Padiatric 31d</span></small>
                    </h3>
                    <img src="<?php echo base_url()?>assets/icons/focus.png" class="tt_img">
                </div>

                ...
                success: function (response) {
                    if (response.type === 'success') {
                        ...
                        window.setTimeout(function () {
                            window.location.href = "<?php echo base_url('/index.php/doctor/doctor_record_list?msg=success'); ?>";
                        }, 2000);
                    } else {
                        jQuery('#publish_button').html(response.message);
                    }
            ...
            jQuery.ajax({
                ...
                success: function (data) {
                    if (data.type === 'error') {
                        ...
                        $('.doctor_assign_msg').html(data.msg);
                        window.setTimeout(function () {
                            window.location = '<?php echo base_url('/index.php/doctor/doctor_record_list/'); ?>';
                        }, 2000);
                    }
                }
            });

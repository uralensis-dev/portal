...
<head>
    ...
    <!--Full Calendar CSS Files-->
    <!-- Summernote CSS -->
    <link rel="stylesheet" href="<?php echo base_url('/assets/newtheme/plugins/summernote/dist/summernote.css'); ?>">
    <!-- Main CSS -->
...
<div class="main-wrapper">
        ...
        <ul class="nav user-menu">
            ...
            <li class="nav-item dropdown has-arrow flag-nav">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?php echo base_url('/assets/newtheme/img/flags/us.png'); ?>" alt="" height="16">
                        English
                    </a>
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?php echo base_url('/assets/newtheme/img/flags/fr.png'); ?>" alt="" height="16">
                        French
                    </a>
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?php echo base_url('/assets/newtheme/img/flags/es.png'); ?>" alt="" height="16">
                        Spanish
                    </a>
                    <a href="javascript:void(0);" class="dropdown-item">
                        <img src="<?php echo base_url('/assets/newtheme/img/flags/de.png'); ?>" alt="" height="16">
                        German
                    </a>
                </div>
            </li>
            ...
            <?php if ($this->ion_auth->in_group('admin')): ?>
                ...
                <li class="new-item"><?php $current_date_year = date('Y'); ?>
                    <a href="<?php echo base_url('index.php/admin/display_all/' . $current_date_year . '/all'); ?>"
                       class="nav-link">
                ...
                <li class="new-item">
                    <a href="<?php echo base_url('index.php/admin/view_further_work?fw_page=requested'); ?>"
                       class="nav-link">
 ...
 <?php if (in_array($group_type,LAB_GROUP)) : ?>
            ...
            <li class="nav-item dropdown">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <i class="fa fa-bell-o"></i> <span
                            class="badge badge-pill"><?php echo count(getNotificationCount($this->ion_auth->user()->row()->id)); ?></span>
                </a>
                                    ...
                                    <li class="notification-message">
                                        <a href="<?php echo($rec->redirect_url != "" ? base_url($rec->redirect_url) : 'javascript:void(0)'); ?>">
                                            <div class="media">
                                                <!--                                                    <span class="avatar">-->
                                                <!--                                                        <img alt="" src="-->
                                                <?php //echo base_url('/assets/newtheme/img/profiles/avatar-02.jpg'); ?><!--">-->
                                                <!--                                                    </span>-->
                                                <div class="media-body">
                                                    <p class="noti-details"><?php echo $rec->notification ?></p>
                                                    <p class="noti-time"><span
                                                                class="notification-time"><?php echo date("d,M,Y h:m", strtotime($rec->startdate)) ?></span>
                                                    </p>
                                                </div>
                                            </div>
                                        </a>
            ...
            <li class="nav-item dropdown hidden" style="display:none">

                <a href="<?php echo site_url('pm/index'); ?>" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    <i class="fa fa-comment-o"></i> <span
                            class="badge badge-pill"><?php echo count(getUnreadMessagesCounter(intval($this->ion_auth->user()->row()->id)));
                                        ...
                                        <a href="javascript:">
                                            <div class="list-item">
                                                ...
                                                <?php if ($rec->profile_picture_path != "") { ?>
                                                    <img alt=""
                                                         src="<?php echo base_url($rec->profile_picture_path); ?>"/>
                                                <?php } else { ?>

                                                    <img alt=""
                                                         src="<?php echo base_url('/assets/img/dummy-doctors.jpg'); ?>"/>
                                                <?php } ?>
                                                </span>
                                                </div>
                                                <div class="list-body">
            ...
            <li class="nav-item dropdown has-arrow main-drop">
                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                    ...
                    ?>
                    <span class="user-img">
                            <img src="<?php if ($userinfo[0]->profile_picture_path != '') echo base_url($userinfo[0]->profile_picture_path); else echo base_url('/assets/img/dummy-doctors.jpg') ?>"
                                 alt="">
                ...
                <div class="dropdown-menu">
                    <a class="dropdown-item"
                       href="<?php echo base_url() ?>auth/edit_user/<?php echo $this->ion_auth->user()->row()->id ?>">My
                        Profile</a>
                    ...
                    <?php if ($_SESSION['admin_id']) { ?>
                        <a class="dropdown-item"
                           href="<?php echo base_url('index.php/institute/switchUserAccountToAdmin/' . $_SESSION['admin_id']); ?>">Logout
                            to Admin</a>
    ...
    <div class="sidebar" id="sidebar">
        <div class="sidebar-inner slimscroll">
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    <li>
                        <a href="<?php echo site_url('auth/index'); ?>"><i class="la la-home"></i>
                            <span>Back to Home</span></a>
                    </li>
                    <!--class="active"-->
                    <li>
                        <a href="<?php echo site_url('pm/index'); ?>">Inbox <span
                                    class="mail-count">(<?php echo count(getUnreadMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?>)</span></a>
                    </li>
                    <!--<li>
                        <a href="#">Starred</a>
                    </li>-->
                    <li>
                        <a href="<?php echo site_url('pm/sent'); ?>">Sent Mail<span
                                    class="mail-count">(<?php echo count(getSentMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?>)</span></a>
                    </li>
                    <!--<li>
                        <a href="#">Trash</a>
                    </li>-->
                    <li>
                        <a href="<?php echo site_url('pm/draft'); ?>">Draft <span
                                    class="mail-count">(<?php echo count(getdraftMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?>)</span></a>
                    </li>
                    <li>
                        <a href="<?php echo site_url('pm/deleted'); ?>">Trash <span
                                    class="mail-count">(<?php echo count(getDeleteMessagesCounter(intval($this->ion_auth->user()->row()->id))); ?>)</span></a>
                    </li>
                    <li class="menu-title">Label <a href="#" data-toggle="modal" data-target="#add_label"><i
                    ...
                    foreach ($getLabels as $rec) {
                        ...
                        ?>
                        <li>
                            <a href="<?php echo site_url('pm/index/0/' . $rec->id); ?>"><i
                                        class="fa fa-circle text-success mail-label"></i> <?php echo $rec->name ?></a>
                        </li>
                    <?php } ?>
                    <!--<li>
    ...
    <div class="page-wrapper">
        ...
        <div class="content container-fluid">
            ...
            <!-- Add Group Modal -->
            <div id="add_label" class="modal custom-modal fade" role="dialog">
                <div class="modal-dialog modal-dialog-centered modal-md" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p>Labls are sorting of your Email with specific tag</p>
                            ...
                            <div class="submit-section">
                                <button class="btn btn-primary btn" onClick="createlabel()">Submit</button>
                            </div>

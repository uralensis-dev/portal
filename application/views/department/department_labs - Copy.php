                                                                        ...
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="table-responsive">
                                                                                <table class="table table-striped table-hover">
                                                                                    ...
                                                                                    <tbody>
                                                                                        <?php foreach ($addTestResult as $resKey => $resValue) { ?>
                                                                                            <tr>
                                                                                                <td><?php echo $resValue["test_id"]; ?></td>
                                                                                                <td><?php echo $resValue["lab_ref_name"]; ?></td>
                                                                                                <td><?php echo $resValue["name"]; ?></td>
                                                                                                <td><?php echo $resValue["billing_code_id"]; ?></td>
                                                                                                <td><?php echo $resValue["path_index"]; ?></td>

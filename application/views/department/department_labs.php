        ...
        <div class="card department-card">
            <div class="card-body">
                <div class="department-title mb-2">
                    <div class="row">
                        <div class="col-md-10 collapse-button" data-label="department" data-id="<?php echo $d_id; ?>" id="department-title-<?php echo $d_id; ?>" data-toggle="collapse" data-target="#specialties-<?php echo $d_id; ?>" aria-expanded="false" aria-controls="specialties-<?php echo $d_id; ?>">
                            <h4>
                        ...
                        <div class="card mb-1 speciality-card">
                            <div class="card-body">
                                <div class="specialty-title mb-2" data-toggle="collapse" >
                                    <div class="row">
                                        <div class="col-md-8 collapse-button" data-label="speciality" data-id="<?php echo $s_id; ?>" id="specialty-title-<?php echo $s_id; ?>" data-toggle="collapse" data-target="#category-<?php echo $s_id; ?>" aria-expanded="false" aria-controls="category-<?php echo $s_id; ?>">
                                            <h4>
                                                <span class="arrow-down mr-2">
                                                    <i class="fa fa-caret-right"></i>
                                                </span>
                                ...
                                <div class="row collapse" id="category-<?php echo $s_id; ?>">
                                    <div class="col">
                                    <br /> 
                                        <h4 class="mb-2"><strong>Sub Speciality</strong> <button data-name="<?php echo $department['name'] ?>/<?php echo $specialty['name']; ?>" data-did="<?php echo $d_id; ?>" data-sid="<?php echo $s_id; ?>" class="add-category-button btn btn-primary btn-sm"><i style="font-size: 12px;" class="fa fa-plus"></i></button></h4>
                                        <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class="row">
                                                <div class="col"><strong>Name</strong></div>
                                                <div class="col  text-center"><strong>Snomed Code</strong></div>
                                    ...
                                    <div class="col">
                                    <br /> 
                                        <h4 class="mb-2"><strong>Procedure</strong> <button data-name="<?php echo $department['name'] ?>/<?php echo $specialty['name']; ?>" data-did="<?php echo $d_id; ?>" data-sid="<?php echo $s_id; ?>" class="add-specimen-button btn btn-primary btn-sm"><i style="font-size: 12px;" class="fa fa-plus"></i></button></h4>
                                        <ul class="list-group">
                                      ...
                                      <br />  
<h4 class="mb-2"><strong>Tissue Type</strong> <button data-name="<?= $department['name'] ?>/<?= $specialty['name']; ?>" data-did="<?= $d_id; ?>" data-sid="<?= $s_id; ?>" class="add-tissue-button btn btn-primary btn-sm"><i style="font-size: 12px;" class="fa fa-plus"></i></button></h4>
                                        <h5 class="text-center mb-2"></h5>
                                        <ul class="list-group">
                                            <?php foreach ($specialty['tissue_type'] as $tt_id => $tissue_type) : ?>
                                                <li class="list-group-item">
                                                    <div class="row">
                                                        <div class="col">
                                                            <span id="tissue-text-<?php echo $tt_id; ?>">
                                                                <?= $tissue_type['name'] ?>
                                                            </span>
                                                        </div>
                                                        <div class="col text-right">
                                                            <span data-name="<?= $tissue_type['name']; ?>" data-did="<?= $d_id; ?>" data-sid="<?= $s_id; ?>" data-id="<?= $tissue_type['id'] ?>" class="edit-tissue mr-2">
                                                                <i class="las la-pen"></i>
                                                            </span>
                                                            <span class="delete-tissue" data-did="<?= $d_id; ?>" data-sid="<?= $s_id; ?>" data-id="<?= $tissue_type['id']; ?>">
                                                                <i class="las la-trash-alt"></i>
                                                            </span>
                                                        </div>
                                                    </div>
                                        ...
                                        <h4 class="mb-2"><strong>Lab Test Categories</strong> </h4>
                                            <?php
                                            foreach ($test_sub_categories['main_cat'] as $mainKey => $mainValue) :
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <?php if (isset($mainValue["sub_cat"]) && count($mainValue["sub_cat"]) > 0) {
                                                        ?>
...
<!--                                        <button data-name="--><?php //echo $department['name'] ?><!--/--><?php //echo $specialty['name']; ?><!--" data-sid="--><?php //echo $s_id; ?><!--" data-did="--><?php //echo $d_id; ?><!--" class="add-test-category-button mt-4 btn btn-primary btn-sm"><i style="font-size: 12px;" class="fa fa-plus"></i> Test Category</button>-->
    ...
    <div id="add-specialty-specimen" class="modal custom-modal fade" role="dialog">
     ...
     <div id="add-tissue-type" class="modal custom-modal fade" role="dialog">
         <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h3 class="modal-title">Add Tissue Type</h3>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                     </button>
                 </div>
                 <div class="modal-body">
                     <div class="form-group mb-2">
                         <div class="row">
                             <div class="col">
                                 <label for="tissue-add-name">Tissue Type Name</label>
                                 <input type="text" id="tissue-add-name" class="form-control">
                             </div>
                         </div>
                     </div>
                     <div class="error-message" id="custom-tissue-error-message">
                         This is an error message
                     </div>
                     <div class="action-button text-right">
                         <button id="custom-tt-add-button" class="btn btn-primary">Add</button>
                         <button data-dismiss="modal" aria-label="Close" class="btn btn-secondary">Cancel</button>
                     </div>
                 </div>
             </div>
    ...
    <div id="edit-specimen" class="modal custom-modal fade" role="dialog">
     ...
     <div id="edit-tissue" class="modal custom-modal fade" role="dialog">
         <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
             <div class="modal-content">
                 <div class="modal-header">
                     <h3 class="modal-title">Edit Tissue Type</h3>
                     <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                         <span aria-hidden="true">&times;</span>
                     </button>
                 </div>
                 <div class="modal-body">
                     <div class="form-group mb-2">
                         <div class="row">
                             <div class="col">
                                 <label for="edit-tissue-name">Tissue Type</label>
                                 <input type="text" id="edit-tissue-name" class="form-control">
                                 <div class="invalid-feedback">
                                 </div>
                                 <input type="hidden" id="t-department-id">
                                 <input type="hidden" id="t-specialty-id">
                                 <input type="hidden" id="t-specimen-id">
                             </div>
                         </div>
                         <div class="error-message" id="edit-tissue-error-message">
                             This is an error message
                         </div>
                     </div>
                     <div class="action-button text-right">
                         <button id="tissue-save-button" class="btn btn-primary">Save</button>
                         <button data-dismiss="modal" aria-label="Close" class="btn btn-secondary">Cancel</button>
                     </div>
                 </div>
             </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="action-button text-center">
                        ...
                        <input type="hidden" id="delete-tissue-id">
...
<input type="hidden" id="selectedDepartment" value=''/>
<input type="hidden" id="selectedSpeciality" value=''/>
<input type="hidden" id="rId" value='<?php echo $hospital['id'];?>'/>
...
<script>
    $(document).ready(function(){
        ...
        var selected_label = $(this).attr("data-label");
        var selected_id = $(this).attr("data-id");
        if(selected_label === 'department'){
            $('#selectedDepartment').val(selected_id);
        }else{
            $('#selectedSpeciality').val(selected_id);
        }

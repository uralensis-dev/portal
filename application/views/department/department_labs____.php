                                            ...
                                            foreach ($test_sub_categories['main_cat'] as $mainKey => $mainValue) :
                                                ...
                                                <li class="list-group-item">
                                                    ...
                                                    <?php if (count($mainValue["sub_cat"]) > 0) { ?>  
                                                        ...
                                                        <div id="showPricing_<?php echo $mainValue['main_cat_id']; ?>" class="collapse" style="margin:10px;">
                                                            <div class="row">
                                                                <?php foreach ($mainValue["sub_cat"] as $subCatKey => $subCatValue) { ?>
                                                                    <div class="row" data-toggle="collapse" data-target="#showtests_<?php echo $subCatValue['sub_cat_id']; ?>">
                                                                        <div class="col">
                                                                            <span id="test-category-text-<?php echo $subCatValue['sub_cat_id']; ?>">
                                                                                <?php echo $subCatValue['sub_cat_name'] ?>
                                                                            </span>
                                                                        </div>


                                                                    </div>
                                                                    <div id="showtests_<?php echo $subCatValue['sub_cat_id']; ?>" class="collapse" style="margin:10px;">
                                                                        <div class="col">
                                                                            <h5 class="text-center mb-2">Tests:</h5>
                                                                            <ul class="list-group">
                                                                                <?php foreach ($subCatValue['tests'] as $testKey => $testValues) : ?>
                                                                                    <li class="list-group-item">
                                                                                        <div class="row">
                                                                                            <div class="col">
                                                                                                <span class="mr-2" id="category-text-<?php echo $testValues["test_id"]; ?>">
                                                                                                    <?php echo $testValues["test_name"] ?>
                                                                                                </span>

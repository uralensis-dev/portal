								...
								<div class="chats">
									...
									<div class="task-header">
										<div class="assignee-info">
											<a href="javascript:;" data-toggle="modal" data-target="#assignee">
												<div class="avatar">
									...
									<div class="task-information">
										<span class="task-info-line"><a class="task-user" href="javascript:;">Lesley Grauer</a> <span class="task-info-subject">created task</span></span>
										<div class="task-time">Jan 20, 2019</div>
									</div>
									<div class="task-information">
										<span class="task-info-line"><a class="task-user" href="javascript:;">Lesley Grauer</a> <span class="task-info-subject">added to Hospital Administration</span></span>
										<div class="task-time">Jan 20, 2019</div>
									</div>
									<div class="task-information">
										<span class="task-info-line"><a class="task-user" href="javascript:;">Lesley Grauer</a> <span class="task-info-subject">assigned to John Doe</span></span>
										<div class="task-time">Jan 20, 2019</div>
									</div>
									<hr class="task-line">
									<div class="task-information">
										<span class="task-info-line"><a class="task-user" href="javascript:;">John Doe</a> <span class="task-info-subject">changed the due date to Sep 28</span> </span>
										<div class="task-time">9:09pm</div>
									</div>
									<div class="task-information">
										<span class="task-info-line"><a class="task-user" href="javascript:;">John Doe</a> <span class="task-info-subject">assigned to you</span></span>
									...
									<div class="completed-task-msg"><span class="task-success"><a href="javascript:;">John Doe</a> completed this task.</span> <span class="task-time">Today at 9:27am</span></div>
									<div class="chat chat-left">
										<div class="chat-avatar">
											<a href="profile.html" class="avatar">
												<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
				...
				<div class="chat-footer">
					<div class="message-bar">
						<div class="message-inner">
							<a class="link attach-icon" href="javascript:;"><img src="assets/img/attachment.png" alt=""></a>
					...
					<div class="project-members task-followers">
						...
						<a class="avatar" href="javascript:;" data-toggle="tooltip" title="Jeffery Lalor">
							<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
						</a>
						<a class="avatar" href="javascript:;" data-toggle="tooltip" title="Richard Miles">
							<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
						</a>
						<a class="avatar" href="javascript:;" data-toggle="tooltip" title="John Smith">
							<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
						</a>
						<a class="avatar" href="javascript:;" data-toggle="tooltip" title="Mike Litorus">
							<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
						</a>
					...
					<div class="row">
						...
						<div class="col-sm-6">
							<div class="form-group">
								...
								<div class="project-members">
									<a class="avatar" href="javascript:;" data-toggle="tooltip" title="John Doe">
										<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
									</a>
									<a class="avatar" href="javascript:;" data-toggle="tooltip" title="Richard Miles">
										<img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
				...
				<div>
					<ul class="chat-user-list">
						<li>
							<a href="javascript:;">
								<div class="media">
									<span class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg"></span>
				...
				<div>
					<ul class="chat-user-list">
						...
						<li>
							<a href="javascript:;">
								<div class="media">
									<span class="avatar"><img alt="" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg-26.jpg"></span>
									<div class="media-body media-middle text-nowrap">

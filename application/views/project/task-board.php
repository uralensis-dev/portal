...
<div class="row board-view-header">
		...
		<div class="pro-teams">
			<div class="pro-team-lead">
				...
				<div class="avatar-group">
					<div class="avatar">
						<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
					</div>
					<div class="avatar">
						<img class="avatar-img rounded-circle border border-white" alt="User Image" src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg">
					</div>
	...
	<div class="col-8 text-right">
		<a href="javascript:;" class="btn btn-white float-right ml-2" data-toggle="modal" data-target="#add_task_board"><i class="fa fa-plus"></i> Create List</a>
				...
				<div class="kanban-header">
					...
					<div class="dropdown kanban-action">
						...
						<div class="dropdown-menu dropdown-menu-right">
							<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#edit_task_board">Edit</a>
						...
						<div class="kanban-box">
							<div class="task-board-header">
								...
								<div class="dropdown kanban-task-action">
									...
									<div class="dropdown-menu dropdown-menu-right">
										<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#edit_task_modal">Edit</a></li>
										<a class="dropdown-item" href="javascript:;">Delete</a></li>
									</div>
								</div>
							</div>
							<div class="task-board-body">
								...
								<div class="kanban-footer">
									...
									<span class="task-users">
										<img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" class="task-avatar" width="24" height="24">
									</span>
								</div>
							</div>
						</div>
					...
					<div class="form-group">
						...
						<div class="task-follower-list">
							<span data-toggle="tooltip" title="John Doe">
								<img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" class="avatar" alt="John Doe" width="20" height="20">
								<i class="fa fa-times"></i>
							</span>
							<span data-toggle="tooltip" title="Richard Miles">
								<img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" class="avatar" alt="Richard Miles" width="20" height="20">
								<i class="fa fa-times"></i>
							</span>
							<span data-toggle="tooltip" title="John Smith">
								<img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" class="avatar" alt="John Smith" width="20" height="20">
								<i class="fa fa-times"></i>
							</span>
							<span data-toggle="tooltip" title="Mike Litorus">
								<img src="<?php echo base_url() ?>assets/img/dummy-doctors.jpg" class="avatar" alt="Mike Litorus" width="20" height="20">
								<i class="fa fa-times"></i>
							</span>
						</div>
					</div>

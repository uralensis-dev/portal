...
<div class="main-wrapper">
    ...
    <div class="header">
        ...
        <!-- /Header Title -->
        <a id="mobile_btn" class="mobile_btn" href="#sidebar"><i class="fa fa-bars"></i></a><form class="tg-formtheme tg-searchrecord">
                <fieldset>
        ...
        <ul class="nav user-menu">
            ...
            <li class="new-item">
                <a href="<?php echo base_url('index.php/admin/doctor_record_list'); ?>" class="nav-link">

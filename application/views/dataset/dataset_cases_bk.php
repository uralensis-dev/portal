                    ...
                    <ul class="tg-filters record-list-filters">
                        ...
                        <li class="tg-statusbar tg-flagcolor custome-flagcolors nobefore search_li" style="padding: 0; max-width:220px;">
                            ...
                            <div class="input-group">
                                <select name="sr_dataset_type" class="form-control" onchange="search_by_type()">
...
<!--                        <td style="width:146px !important" width="146">--><?php //echo $courierNo; ?><!--<br>--><?php //echo $batchNo; ?><!--</td>-->
                        ...
                        <td>
                            <a  class="edit-icon" href="<?php echo site_url() . '/doctor/doctor_record_detail_old/' . $row->uralensis_request_id; ?>">

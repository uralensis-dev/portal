    ...
    <div class="sidebar-inner slimscroll">
		<div class="sidebar-menu">
			<ul>
				...
				<li class="menu-title"><span>Chat Groups</span> <a href="javascript:;" data-toggle="modal" data-target="#add_group"><i class="fa fa-plus"></i></a></li>
				<li> 
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="	user.jpg">
						</span> 
				...
				<li> 
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url() ?>assets/img/user.jpg">
						</span> 
				...
				<li class="menu-title">Direct Chats <a href="javascript:;" data-toggle="modal" data-target="#add_chat_user"><i class="fa fa-plus"></i></a></li>
				<li>
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg-02.jpg"><span class="status online"></span>
						</span> 
				...
				<li>
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg-09.jpg"><span class="status offline"></span>
						</span> 
				...
				<li>
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg-10.jpg"><span class="status away"></span>
						</span> 
				...
				<li class="active">
					<a href="<?php echo base_url() ?>index.php/comms/chat">
						<span class="chat-avatar-sm user-img">
							<img class="rounded-circle" alt="" src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg-05.jpg"><span class="status online"></span>
						</span> 
						...
						<div class="user-details mr-auto">
							<div class="float-left user-img">
								<a class="avatar" href="javascript:;" title="Mike Litorus">
									<img src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg" alt="" class="rounded-circle">
									<span class="status online"></span>
								</a>
							</div>
							<div class="user-info float-left">
								<a href="javascript:;" title="Mike Litorus"><span>Mike Litorus</span> <i class="typing-text">Typing...</i></a>
										...
										<div class="chat-body">
											<div class="chat-bubble">
												...
												<div class="chat-action-btns">
													<ul>
														<li><a href="javascript:;" class="share-msg" title="Share"><i class="fa fa-share-alt"></i></a></li>
														<li><a href="javascript:;" class="edit-msg"><i class="fa fa-pencil"></i></a></li>
														<li><a href="javascript:;" class="del-msg"><i class="fa fa-trash-o"></i></a></li>
													</ul>
												</div>
											</div>
										</div>
									...
									<div class="chat chat-left">
										<div class="chat-avatar">
											<a href="javascript:;" class="avatar">
												<img alt="" src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg">
											</a>
										</div>
										<div class="chat-body">
											<div class="chat-bubble">
												...
												<div class="chat-content img-content">
													<div class="chat-img-group clearfix">
														...
														<a class="chat-img-attach" href="javascript:;">
															<img width="182" height="137" alt="" src="<?php echo base_url() ?>assets/img/placeholder.jpg">
											...
											<div class="chat-bubble">
												<div class="chat-content">
													...
													<ul class="attach-list">
														<li><i class="fa fa-file"></i> <a href="javascript:;">example.avi</a></li>
														<li><i class="fa fa-file"></i> <a href="javascript:;">activity.psd</a></li>
														<li><i class="fa fa-file"></i> <a href="javascript:;">example.psd</a></li>
													</ul>
												</div>
												<div class="chat-action-btns">
													<ul>
				...
				<div class="chat-footer">
					<div class="message-bar">
						<div class="message-inner">
							<a class="link attach-icon" href="javascript:;" data-toggle="modal" data-target="#drag_files"><img src="<?php echo base_url() ?>assets/img/attachment.png" alt=""></a>
											...
											<div class="chat-bubble">
												<div class="chat-content">
													...
													<div class="call-details">
														...
														<div class="call-info">
															<div class="call-user-details">
																<a href="javascript:;" class="call-description call-description--linked" data-qa="call_attachment_link">Calling John Smith ...</a>
															</div>
														</div>
													</div>
												</div>
									...
									<div class="table-content">
										<div class="chat-profile-img">
											<div class="edit-profile-img">
												<img src="<?php echo base_url() ?><?php echo base_url() ?>assets/img/dummy-doctors.jpg" alt="">
														...
														<li>
															<div class="files-cont">
																...
																<div class="files-info">
																	...
																	<span class="file-author"><a href="javascript:;">Loren Gatlin</a></span> <span class="file-date">May 31st at 6:53 PM</span>
																</div>
																<ul class="files-action">
																	<li class="dropdown dropdown-action">
																		...
																		<div class="dropdown-menu">
																			...
																			<a class="dropdown-item" href="javascript:;" data-toggle="modal" data-target="#share_files">Share</a>
																		</div>
																	</li>
																</ul>
															</div>
													...
													<ul class="files-list">
														<li>
															<div class="files-cont">
																...
																<div class="files-info">
																	<span class="file-name text-ellipsis">AHA Selfcare Mobile Application Test-Cases.xls</span>
																	<span class="file-author"><a href="javascript:;">John Doe</a></span> <span class="file-date">May 31st at 6:53 PM</span>
																</div>
																<ul class="files-action">
																	<li class="dropdown dropdown-action">
																		<a href="" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_horiz</i></a>
			...
			<div class="modal-body">
				<div class="files-share-list">
					<div class="files-cont">
						...
						<div class="files-info">
							<span class="file-name text-ellipsis">AHA Selfcare Mobile Application Test-Cases.xls</span>
							<span class="file-author"><a href="javascript:;">Bernardo Galaviz</a></span> <span class="file-date">May 31st at 6:53 PM</span>
						</div>
					</div>
				</div>
				<div class="form-group">

...
<div class="page-header">
    <div class="row align-items-center">
        <div class="col">
            ...
            <ul class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/shared_list') ?>">Document</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="sec_title p_id form-group">
		                       ...
		                       <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group tg-inputwithicon edit-icon-top">
                                            ...
                                            <input type="date" name="date_of_1_issue" id="date_of_1_issue" value="<?php echo (isset($result['date_of_1_issue']))?$result['date_of_1_issue']:''; ?>" class="form-control" placeholder="Date of 1st Issue">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                   ...
                                   <div class="col-md-3">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group tg-inputwithicon edit-icon-top">
                                            <label for="address1-input">Revised Review Date</label>
                                            <i class="lnr lnr-calendar-full"></i>
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group tg-inputwithicon">
                                            ...
                                            <input type="text" name="obsolete_document_owner" id="obsolete_document_owner" value="<?php echo (isset($result['obsolete_document_owner']))?$result['obsolete_document_owner']:''; ?>" class="form-control" placeholder="Obsolete Document Owner">
                                        </div>
                                    </div>
	 ...
	 <div class="col-md-12">
		...
		<button type="submit" style="margin:10px;" class="btn btn-danger btn-rounded create_new_next_button pull-right"

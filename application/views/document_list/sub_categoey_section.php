    ...
    <div class="row align-items-center">
        <div class="col">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List') ?>">Document</a></li>
			 <li class="breadcrumb-item"><a href="<?php echo base_url('Document_List/sub_category_list') ?>">Sub Category</a></li>
							  ...
							  <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <label>Category</label>
                                            <select  name="category_id" id="category_id" value="" class="form-control select">
											
											<option value="">Select Category</option>
										    <?php foreach ($category as $crow) : ?>
												 <?php $category = (isset($result['category_id']))?$result['category_id']:''; 

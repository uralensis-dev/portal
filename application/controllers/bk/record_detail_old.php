<style type="text/css">
    ...
    .table:hover .edit_icon{opacity: 1}
...
<div id="edit_record_history" class="modal fade" role="dialog">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 form-group">
                ...
                <div class="tg-breadcrumbarea tg-searchrecordhold">
                    ...
                    <div class="col-md-3 text-right tg-rightarea tg-rightsearchrecord">
                        ...
                        <figure class="tg-logobar pull-right">
    ...
    <div class="tg-haslayout">
        <div class="container-fluid tab-full" style="padding-right: 130px;">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <div class="col-md-12 text-right nopadding-right">
                        <button class="btn btn-info btn-sm btn_collapse_all" title="Collapse All">
                        ...
                        <div class="col-md-12 form-group" style="padding-right: 0;">
                            <div class="sec_title p_id form-group">
                               ...
                               <!--  <span id="p_id_title">
                                ...
                                <table class="table custom-table info_nndn2" style="margin-bottom: 0;">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td>
                                            ...
                                            <span  style="font-weight: 500; display:inline-block; margin-top: 12px;"><?php echo uralensis_get_user_data($request_query[0]->uralensis_request_id, 'fullname'); ?></span>
                                        </td>
                                        <td>
                                            <span style="font-weight: 500">DOB: <?php echo !empty($request_query[0]->dob) ? date('d-m-Y', strtotime($request_query[0]->dob)) : ''; ?></span>
                                        </td>
                                        <td><span style="font-weight: 500">NHS: <?php echo $request_query[0]->nhs_number; ?></span></td>
                                        <td>
                                            <span style="font-weight: 500">Age/Gender: <?php print @date_diff(date_create($request_query[0]->dob), date_create('today'))->y;?>/<?php $gender = ($request_query[0]->gender == 'Male' ? 'M' : 'F'); ?>
                                                <?php echo $gender; ?>
                                            </span>
                                        </td>
                                        <td class="text-right">
                            ...
                            <div class="sec_title r_id form-group">
                                ...
                                <table class="table custom-table info_nndn2" style="margin-bottom: 0;">
                                    <tr style="box-shadow:0px 0px 0px 0px !important;">
                                        ...
                                        <td><span style="font-weight: 500">Request ID : </span></td>
                                        <td><span style="font-weight: 500">Pathologist : <span><img src="<?php echo base_url();?>assets/img/person-male.png" class="img-fluid img-thumbnail img-circle" width="40"></span></span></td>
                                        <td>
                                            <span style="font-weight: 500">Specimen Nature: <?php echo $request_type; ?>
                                            </span>
                                        </td>
                                        <td><span style="font-weight: 500">Hospital Name:  <?php echo $row2->hospital_id;?>
                                            </span> 
                                        </td>
                                        <td>
                                            <span style="font-weight: 500">Lab Name:  <?php echo getGroupNameById($row->lab_id); ?></span>
                                        </td>
                                        <td class="text-right">
                                            <span class="pull-right edit_icon  new_edit">
                                                <i class="fa fa-pencil"></i>
                                            </span>
                                            <!-- <span class="btn btn-info btn-sm pull-right btn_save_sec hidden" id="save_patient" style="margin-right:10px; border-radius:4px;">
                                                <i class="fa fa-save"></i>
                                ...
                                <!-- <a href="javascript:;" class="checv_up_down"><i class="fa fa-eye"></i></a> -->
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            ...
                                                            <div class="table-view-content"><?php echo $request_type; ?></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            ...
                                                            <div class="table-view-content"><?php echo $row->speciality_group_id; ?></div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="table-view-container">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-9 ">
                                                            ...
                                                            <div class="table-view-content"><?php echo $row->specimen_id; ?></div>
                                                        </div>
                                                    </div>
...
<?php
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="dermatological_surgeon">Dermatological Surgeon -
                                                    Pcr7100</label>
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <div class="form_input_container" data-key="pathologist">
                                                    ...
                                                    <select name="pathologist" id="pathologist"
                                                            class="form_input">
                                                        <option value="">Choose</option>
                                                        <?php echo $this->Doctor_model->get_pathologist($row->hospital_group_id, 'dermatological', $row->dermatological_surgeon); ?>
                                                    </select>
                ...
                <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                    <ul class="tg-themedetailsicon">
                            <li>
                                ...
                                <?php } ?>
                                <a href="<?php echo site_url() . '/doctor/add_further_work/' . $request_query[0]->uralensis_request_id; ?>" class="tg-detailsicon"  title="Add Further Work">
                                    <span title="Add Further Work" class="tg-notificationtag"><i class="fa fa-plus"></i></span>
                                ...
                                <a href="javascript:;" class="tg-detailsicon" data-toggle="modal" title="Assign as teaching and cpc"
                                   ...
                                   <i title="Assign as teaching and cpc"
                                    ...
                                    <a href="javascript:;" class="tg-detailsicon" data-toggle="modal" title="Add Supplementarty Report"
                                       ...
                                       <i title="Add Supplementarty Report" class="ti-plus"></i></a>
                                   <?php } ?>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $(".btn_collapse_all").click(function(){
            ...
            $(".btn_collapse_all i.las").toggleClass("la-expand-arrows-alt");
            $(".btn_collapse_all i.las").toggleClass("la-compress-arrows-alt");

            // $(".checv_up_down .fa").toggleClass("fa-chevron-down");
            // $(".checv_up_down .fa").toggleClass("fa-chevron-up");
            // $(".make_editable").toggleClass("show");
        });

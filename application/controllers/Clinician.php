...
class Clinician extends CI_Controller
{
    /**
    ...
    public function index()
    {
        ...
        $clinician_id = $this->ion_auth->user()->row()->id;

        //Get Records Bases On Current Dermatological Surgeon
        $result['result'] = $this->db->where('clrk', $clinician_id)->get('request')->result_array();
        $this->load->view('clinician/inc/header');
        $this->load->view('clinician/index', $result);
        $this->load->view('clinician/inc/footer');
    }
    ...
    public function record_detail($record_id) 
    {
        ...
        $this->load->view('clinician/inc/header');
        $this->load->view('clinician/record_detail', $result);
        $this->load->view('clinician/inc/footer');
    }

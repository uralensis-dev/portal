 ...
 * @version    1.0.0
 */
class ncwtmds extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('ncwtmds/inc/header-new');
        $this->load->view('ncwtmds/index');
        $this->load->view('ncwtmds/inc/footer-new');
    }
    public function cw_data()
    {
        ...
        $this->load->view('ncwtmds/inc/header-new');
        $this->load->view('ncwtmds/CW_data');
        $this->load->view('ncwtmds/inc/footer-new');
    }

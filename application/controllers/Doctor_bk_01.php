...
//        pre($data);
    ...
    public function generate_report($id)
    {
        ...
        if (isset($id) && !empty($id)) {
            ...
            $templateArr = $this->db->order_by('id', 'desc')->get_where('lab_templates', ['lab_id' => $labReportId])->row_array();
    ...
    public function update_client_report()
    {
        ...
        if (isset($_POST)) {
            ...
            $spec = array(
                ...
                'specimen_microscopic_code' => implode(",",$this->input->post('specimen_microscopic_code')),

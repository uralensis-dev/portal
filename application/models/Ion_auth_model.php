...
//		exit;
		...
		$query = "INSERT INTO $tableName (first_name, last_name, company, phone, user_type, memorable,user_auth_pass, email, username, password, ip_address, created_on, active, profile_picture_path, is_hospital_admin, division_id, department_id,speciality_id,category_id,sub_role, clinic_id) 
                    VALUES (

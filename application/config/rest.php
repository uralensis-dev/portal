...
|
*/
$config['rest_valid_logins'] = ['admin' => 'HwuKUP2LrZH5XgQk'];
...
|
*/
$config['allowed_cors_origins'] = ['https://slide-management.uralensis.com', 'https://www.slide-management.uralensis.com'];

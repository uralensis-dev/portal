    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                ...
                .append("<div class='col-md-12'><div class='form-group'><label class='control-label'>Event Description</label><input class='form-control' type='text' name='desc'/></div></div>")
                ...
                .append("<option value='cut_up'>Cut Up</option>")
                .append("<option value='mdt'>MDT</option>")
                .append("<option value='microscopy'>Microscopy</option>")
                .append("<option value='holidays_hours'>Holiday Hours</option>")
                .append("<option value='sick_days'>Sick Days</option>")
                .append("<option value='overtime'>Overtime</option>");
            $this.$modal.find('.delete-event').hide().end().find('.save-event').show().end().find('.modal-body').empty().prepend(form).end().find('.save-event').unbind('click').click(function () {
                form.submit();
            });
            $this.$modal.find('form').on('submit', function () {
                var title = form.find("input[name='title']").val();
                var title = form.find("input[name='desc']").val();

...
// Add data
    chart.data = all_docs_l_month_data;
...
// Create axes
    ...
    dateAxis.dataFields.category = ""+x_axis_name+"";
    ...
    series3.dataFields.categoryX  = ""+x_axis_name+"";
    series3.name = "Target";
    ...
    series4.dataFields.categoryX  = ""+""+x_axis_name+""+"";
    series4.name = "Tat < 10";
...
// Add events
    ...
    method:"POST",
    data: { "report_month":ev.target.dataItem.category},
    dataType: "json",
...
// create chart
    ...
    chart.data = avg_last_month_tat_data;
...
// create chart
            ...
            chart.data = avg_last_3m_tat_data;
            // alert(chart.data['avg_tat']);
...
// create chart
            ...
            chart.data = avg_last_6m_tat_data;
